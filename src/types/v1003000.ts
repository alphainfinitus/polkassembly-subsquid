...
export type OriginCaller = OriginCaller_AllianceMotion | OriginCaller_AmbassadorOrigins | OriginCaller_CumulusXcm | OriginCaller_FellowshipOrigins | OriginCaller_PolkadotXcm | OriginCaller_Void | OriginCaller_system
...
export interface OriginCaller_AmbassadorOrigins {
    __kind: 'AmbassadorOrigins'
    value: Type_230
}
...
export type Type_229 = Type_229_Architects | Type_229_FastPromoteTo1Dan | Type_229_FastPromoteTo2Dan | Type_229_FastPromoteTo3Dan | Type_229_Fellows | Type_229_Fellowship2Dan | Type_229_Fellowship5Dan | Type_229_Fellowship6Dan | Type_229_Fellowship8Dan | Type_229_Fellowship9Dan | Type_229_Masters | Type_229_Members | Type_229_PromoteTo1Dan | Type_229_PromoteTo2Dan | Type_229_PromoteTo3Dan | Type_229_PromoteTo4Dan | Type_229_PromoteTo5Dan | Type_229_PromoteTo6Dan | Type_229_RetainAt1Dan | Type_229_RetainAt2Dan | Type_229_RetainAt3Dan | Type_229_RetainAt4Dan | Type_229_RetainAt5Dan | Type_229_RetainAt6Dan

export interface Type_229_Architects {
    __kind: 'Architects'
}

export interface Type_229_FastPromoteTo1Dan {
    __kind: 'FastPromoteTo1Dan'
}

export interface Type_229_FastPromoteTo2Dan {
    __kind: 'FastPromoteTo2Dan'
}

export interface Type_229_FastPromoteTo3Dan {
    __kind: 'FastPromoteTo3Dan'
}

export interface Type_229_Fellows {
    __kind: 'Fellows'
}

export interface Type_229_Fellowship2Dan {
    __kind: 'Fellowship2Dan'
}

export interface Type_229_Fellowship5Dan {
    __kind: 'Fellowship5Dan'
}

export interface Type_229_Fellowship6Dan {
    __kind: 'Fellowship6Dan'
}

export interface Type_229_Fellowship8Dan {
    __kind: 'Fellowship8Dan'
}

export interface Type_229_Fellowship9Dan {
    __kind: 'Fellowship9Dan'
}

export interface Type_229_Masters {
    __kind: 'Masters'
}

export interface Type_229_Members {
    __kind: 'Members'
}

export interface Type_229_PromoteTo1Dan {
    __kind: 'PromoteTo1Dan'
}

export interface Type_229_PromoteTo2Dan {
    __kind: 'PromoteTo2Dan'
}

export interface Type_229_PromoteTo3Dan {
    __kind: 'PromoteTo3Dan'
}

export interface Type_229_PromoteTo4Dan {
    __kind: 'PromoteTo4Dan'
}

export interface Type_229_PromoteTo5Dan {
    __kind: 'PromoteTo5Dan'
}

export interface Type_229_PromoteTo6Dan {
    __kind: 'PromoteTo6Dan'
}

export interface Type_229_RetainAt1Dan {
    __kind: 'RetainAt1Dan'
}

export interface Type_229_RetainAt2Dan {
    __kind: 'RetainAt2Dan'
}

export interface Type_229_RetainAt3Dan {
    __kind: 'RetainAt3Dan'
}

export interface Type_229_RetainAt4Dan {
    __kind: 'RetainAt4Dan'
}

export interface Type_229_RetainAt5Dan {
    __kind: 'RetainAt5Dan'
}

export interface Type_229_RetainAt6Dan {
    __kind: 'RetainAt6Dan'
}

export type Type_227 = Type_227_Relay | Type_227_SiblingParachain

export interface Type_227_Relay {
    __kind: 'Relay'
}

export interface Type_227_SiblingParachain {
...
export type Type_230 = Type_230_Ambassadors | Type_230_HeadAmbassadors | Type_230_SeniorAmbassadors

export interface Type_230_Ambassadors {
    __kind: 'Ambassadors'
}

export interface Type_230_HeadAmbassadors {
    __kind: 'HeadAmbassadors'
}

export interface Type_230_SeniorAmbassadors {
    __kind: 'SeniorAmbassadors'
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        AllianceMotion: Type_228,
        AmbassadorOrigins: Type_230,
        CumulusXcm: Type_227,
        FellowshipOrigins: Type_229,
        PolkadotXcm: Origin,
        Void: Void,
        system: RawOrigin,
    }
...
export const Type_229: sts.Type<Type_229> = sts.closedEnum(() => {
    return  {
        Architects: sts.unit(),
        FastPromoteTo1Dan: sts.unit(),
        FastPromoteTo2Dan: sts.unit(),
        FastPromoteTo3Dan: sts.unit(),
        Fellows: sts.unit(),
        ...
        Masters: sts.unit(),
        Members: sts.unit(),
        PromoteTo1Dan: sts.unit(),
        PromoteTo2Dan: sts.unit(),
        PromoteTo3Dan: sts.unit(),
        PromoteTo4Dan: sts.unit(),
        PromoteTo5Dan: sts.unit(),
        PromoteTo6Dan: sts.unit(),
        RetainAt1Dan: sts.unit(),
        RetainAt2Dan: sts.unit(),
        RetainAt3Dan: sts.unit(),
        RetainAt4Dan: sts.unit(),
        RetainAt5Dan: sts.unit(),
        RetainAt6Dan: sts.unit(),
    }
})
...
export const Type_230: sts.Type<Type_230> = sts.closedEnum(() => {
    return  {
        Ambassadors: sts.unit(),
        HeadAmbassadors: sts.unit(),
        SeniorAmbassadors: sts.unit(),
    }
})
...
export type Call = Call_Alliance | Call_AllianceMotion | Call_AmbassadorCollective | Call_AmbassadorCore | Call_AmbassadorReferenda | Call_AmbassadorSalary | Call_AmbassadorTreasury | Call_AssetRate | Call_Balances | Call_CollatorSelection | Call_CumulusXcm | Call_FellowshipCollective | Call_FellowshipCore | Call_FellowshipReferenda | Call_FellowshipSalary | Call_FellowshipTreasury | Call_MessageQueue | Call_Multisig | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Scheduler | Call_Session | Call_System | Call_Timestamp | Call_Utility | Call_XcmpQueue
...
export interface Call_AmbassadorCollective {
    __kind: 'AmbassadorCollective'
    value: AmbassadorCollectiveCall
}

export interface Call_AmbassadorCore {
    __kind: 'AmbassadorCore'
    value: AmbassadorCoreCall
}

export interface Call_AmbassadorReferenda {
    __kind: 'AmbassadorReferenda'
    value: AmbassadorReferendaCall
}

export interface Call_AmbassadorSalary {
    __kind: 'AmbassadorSalary'
    value: AmbassadorSalaryCall
}

export interface Call_AmbassadorTreasury {
    __kind: 'AmbassadorTreasury'
    value: AmbassadorTreasuryCall
}
...
export interface Call_FellowshipTreasury {
    __kind: 'FellowshipTreasury'
    value: FellowshipTreasuryCall
}
...
export type ProxyType = ProxyType_Alliance | ProxyType_Ambassador | ProxyType_Any | ProxyType_CancelProxy | ProxyType_Collator | ProxyType_Fellowship | ProxyType_NonTransfer

export interface ProxyType_Alliance {
    __kind: 'Alliance'
}

export interface ProxyType_Ambassador {
    __kind: 'Ambassador'
}
...
export type Type_206 = Type_206_V2 | Type_206_V3 | Type_206_V4

export interface Type_206_V2 {
    __kind: 'V2'
    value: Type_209[]
}

export interface Type_206_V3 {
    __kind: 'V3'
    value: Type_213[]
}

export interface Type_206_V4 {
    __kind: 'V4'
    value: Type_216[]
}

export type Type_216 = Type_216_AliasOrigin | Type_216_BurnAsset | Type_216_BuyExecution | Type_216_ClaimAsset | Type_216_ClearError | Type_216_ClearOrigin | Type_216_ClearTopic | Type_216_ClearTransactStatus | Type_216_DepositAsset | Type_216_DepositReserveAsset | Type_216_DescendOrigin | Type_216_ExchangeAsset | Type_216_ExpectAsset | Type_216_ExpectError | Type_216_ExpectOrigin | Type_216_ExpectPallet | Type_216_ExpectTransactStatus | Type_216_ExportMessage | Type_216_HrmpChannelAccepted | Type_216_HrmpChannelClosing | Type_216_HrmpNewChannelOpenRequest | Type_216_InitiateReserveWithdraw | Type_216_InitiateTeleport | Type_216_LockAsset | Type_216_NoteUnlockable | Type_216_QueryPallet | Type_216_QueryResponse | Type_216_ReceiveTeleportedAsset | Type_216_RefundSurplus | Type_216_ReportError | Type_216_ReportHolding | Type_216_ReportTransactStatus | Type_216_RequestUnlock | Type_216_ReserveAssetDeposited | Type_216_SetAppendix | Type_216_SetErrorHandler | Type_216_SetFeesMode | Type_216_SetTopic | Type_216_SubscribeVersion | Type_216_Transact | Type_216_TransferAsset | Type_216_TransferReserveAsset | Type_216_Trap | Type_216_UniversalOrigin | Type_216_UnlockAsset | Type_216_UnpaidExecution | Type_216_UnsubscribeVersion | Type_216_WithdrawAsset

export interface Type_216_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V4Location
}

export interface Type_216_BurnAsset {
    __kind: 'BurnAsset'
    value: V4Asset[]
}
...
export interface Type_216_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V4Asset[]
    ticket: V4Location
}

export interface Type_216_ClearError {
    __kind: 'ClearError'
}

export interface Type_216_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_216_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_216_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_216_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V4Junctions
}
...
export interface Type_216_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V4Asset[]
}

export interface Type_216_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_216_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V4Location | undefined)
}

export interface Type_216_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_216_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_216_ExportMessage {
    __kind: 'ExportMessage'
    network: V4NetworkId
    destination: V4Junctions
    xcm: V4Instruction[]
...
export interface Type_216_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_216_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_216_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_216_LockAsset {
    __kind: 'LockAsset'
    asset: V4Asset
    unlocker: V4Location
}

export interface Type_216_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V4Asset
    owner: V4Location
}

export interface Type_216_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V4QueryResponseInfo
}

export interface Type_216_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V4Response
    maxWeight: Weight
...
export interface Type_216_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V4Asset[]
}

export interface Type_216_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_216_ReportError {
    __kind: 'ReportError'
    value: V4QueryResponseInfo
}

export interface Type_216_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V4QueryResponseInfo
    assets: V4AssetFilter
}

export interface Type_216_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V4QueryResponseInfo
}

export interface Type_216_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V4Asset
    locker: V4Location
}

export interface Type_216_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V4Asset[]
}

export interface Type_216_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_216[]
}

export interface Type_216_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_216[]
}

export interface Type_216_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_216_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_216_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_216_Transact {
    __kind: 'Transact'
    originKind: V3OriginKind
    requireWeightAtMost: Weight
    call: Type_210
...
export interface Type_216_TransferAsset {
    __kind: 'TransferAsset'
    assets: V4Asset[]
    beneficiary: V4Location
}

export interface Type_216_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V4Asset[]
    dest: V4Location
    xcm: V4Instruction[]
...
export interface Type_216_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_216_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V4Junction
}

export interface Type_216_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V4Asset
    target: V4Location
}

export interface Type_216_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V4Location | undefined)
}

export interface Type_216_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_216_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V4Asset[]
}
...
export type Type_213 = Type_213_AliasOrigin | Type_213_BurnAsset | Type_213_BuyExecution | Type_213_ClaimAsset | Type_213_ClearError | Type_213_ClearOrigin | Type_213_ClearTopic | Type_213_ClearTransactStatus | Type_213_DepositAsset | Type_213_DepositReserveAsset | Type_213_DescendOrigin | Type_213_ExchangeAsset | Type_213_ExpectAsset | Type_213_ExpectError | Type_213_ExpectOrigin | Type_213_ExpectPallet | Type_213_ExpectTransactStatus | Type_213_ExportMessage | Type_213_HrmpChannelAccepted | Type_213_HrmpChannelClosing | Type_213_HrmpNewChannelOpenRequest | Type_213_InitiateReserveWithdraw | Type_213_InitiateTeleport | Type_213_LockAsset | Type_213_NoteUnlockable | Type_213_QueryPallet | Type_213_QueryResponse | Type_213_ReceiveTeleportedAsset | Type_213_RefundSurplus | Type_213_ReportError | Type_213_ReportHolding | Type_213_ReportTransactStatus | Type_213_RequestUnlock | Type_213_ReserveAssetDeposited | Type_213_SetAppendix | Type_213_SetErrorHandler | Type_213_SetFeesMode | Type_213_SetTopic | Type_213_SubscribeVersion | Type_213_Transact | Type_213_TransferAsset | Type_213_TransferReserveAsset | Type_213_Trap | Type_213_UniversalOrigin | Type_213_UnlockAsset | Type_213_UnpaidExecution | Type_213_UnsubscribeVersion | Type_213_WithdrawAsset

export interface Type_213_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_213_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}

export interface Type_213_BuyExecution {
    __kind: 'BuyExecution'
    fees: V3MultiAsset
    weightLimit: V3WeightLimit
}

export interface Type_213_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_213_ClearError {
    __kind: 'ClearError'
}

export interface Type_213_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_213_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_213_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_213_DepositAsset {
    __kind: 'DepositAsset'
    assets: V3MultiAssetFilter
    beneficiary: V3MultiLocation
}

export interface Type_213_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_213_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}

export interface Type_213_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V3MultiAssetFilter
    want: V3MultiAsset[]
    maximal: boolean
...
export interface Type_213_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_213_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_213_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_213_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_213_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_213_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_213_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_213_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_213_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_213_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V3MultiAssetFilter
    reserve: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_213_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V3MultiAssetFilter
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_213_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_213_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_213_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}

export interface Type_213_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V3Response
    maxWeight: Weight
...
export interface Type_213_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_213_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_213_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_213_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_213_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_213_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_213_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_213_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_213[]
}

export interface Type_213_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_213[]
}

export interface Type_213_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_213_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_213_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_213_Transact {
    __kind: 'Transact'
    originKind: V3OriginKind
    requireWeightAtMost: Weight
    call: Type_210
...
export interface Type_213_TransferAsset {
    __kind: 'TransferAsset'
    assets: V3MultiAsset[]
    beneficiary: V3MultiLocation
}

export interface Type_213_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V3MultiAsset[]
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_213_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_213_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_213_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_213_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}

export interface Type_213_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_213_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V3MultiAsset[]
}

export type Type_209 = Type_209_BuyExecution | Type_209_ClaimAsset | Type_209_ClearError | Type_209_ClearOrigin | Type_209_DepositAsset | Type_209_DepositReserveAsset | Type_209_DescendOrigin | Type_209_ExchangeAsset | Type_209_HrmpChannelAccepted | Type_209_HrmpChannelClosing | Type_209_HrmpNewChannelOpenRequest | Type_209_InitiateReserveWithdraw | Type_209_InitiateTeleport | Type_209_QueryHolding | Type_209_QueryResponse | Type_209_ReceiveTeleportedAsset | Type_209_RefundSurplus | Type_209_ReportError | Type_209_ReserveAssetDeposited | Type_209_SetAppendix | Type_209_SetErrorHandler | Type_209_SubscribeVersion | Type_209_Transact | Type_209_TransferAsset | Type_209_TransferReserveAsset | Type_209_Trap | Type_209_UnsubscribeVersion | Type_209_WithdrawAsset

export interface Type_209_BuyExecution {
    __kind: 'BuyExecution'
    fees: V2MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_209_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_209_ClearError {
    __kind: 'ClearError'
}

export interface Type_209_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_209_DepositAsset {
    __kind: 'DepositAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    beneficiary: V2MultiLocation
...
export interface Type_209_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    dest: V2MultiLocation
...
export interface Type_209_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}

export interface Type_209_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V2MultiAssetFilter
    receive: V2MultiAsset[]
}

export interface Type_209_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_209_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_209_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_209_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V2MultiAssetFilter
    reserve: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_209_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V2MultiAssetFilter
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_209_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export interface Type_209_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_209_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_209_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_209_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_209_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_209_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_209[]
}

export interface Type_209_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_209[]
}

export interface Type_209_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_209_Transact {
    __kind: 'Transact'
    originType: V2OriginKind
    requireWeightAtMost: bigint
    call: Type_210
...
export interface Type_209_TransferAsset {
    __kind: 'TransferAsset'
    assets: V2MultiAsset[]
    beneficiary: V2MultiLocation
}

export interface Type_209_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V2MultiAsset[]
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_209_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_209_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_209_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V2MultiAsset[]
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type FellowshipTreasuryCall = FellowshipTreasuryCall_check_status | FellowshipTreasuryCall_payout | FellowshipTreasuryCall_remove_approval | FellowshipTreasuryCall_spend | FellowshipTreasuryCall_spend_local | FellowshipTreasuryCall_void_spend
 ...
 */
export interface FellowshipTreasuryCall_check_status {
    __kind: 'check_status'
    index: number
}
 ...
 */
export interface FellowshipTreasuryCall_payout {
    __kind: 'payout'
    index: number
}
 ...
 *   in the first place.
 */
export interface FellowshipTreasuryCall_remove_approval {
 ...
 */
export interface FellowshipTreasuryCall_spend {
    __kind: 'spend'
 ...
 */
export interface FellowshipTreasuryCall_spend_local {
    __kind: 'spend_local'
    amount: bigint
 ...
 */
export interface FellowshipTreasuryCall_void_spend {
    __kind: 'void_spend'
    index: number
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type FellowshipSalaryCall = FellowshipSalaryCall_bump | FellowshipSalaryCall_check_payment | FellowshipSalaryCall_induct | FellowshipSalaryCall_init | FellowshipSalaryCall_payout | FellowshipSalaryCall_payout_other | FellowshipSalaryCall_register
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type FellowshipCoreCall = FellowshipCoreCall_approve | FellowshipCoreCall_bump | FellowshipCoreCall_import | FellowshipCoreCall_induct | FellowshipCoreCall_offboard | FellowshipCoreCall_promote | FellowshipCoreCall_promote_fast | FellowshipCoreCall_set_active | FellowshipCoreCall_set_params | FellowshipCoreCall_set_partial_params | FellowshipCoreCall_submit_evidence
 ...
 * be inducted.
 */
export interface FellowshipCoreCall_promote_fast {
    __kind: 'promote_fast'
    who: AccountId32
    toRank: number
}
 ...
 */
export interface FellowshipCoreCall_set_partial_params {
    __kind: 'set_partial_params'
    partialParams: Type_256
}
...
export type Wish = Wish_Promotion | Wish_Retention
...
export interface Type_256 {
    activeSalary: (bigint | undefined)[]
    passiveSalary: (bigint | undefined)[]
    demotionPeriod: (number | undefined)[]
    minPromotionPeriod: (number | undefined)[]
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type AmbassadorTreasuryCall = AmbassadorTreasuryCall_check_status | AmbassadorTreasuryCall_payout | AmbassadorTreasuryCall_remove_approval | AmbassadorTreasuryCall_spend | AmbassadorTreasuryCall_spend_local | AmbassadorTreasuryCall_void_spend
 ...
 * Emits [`Event::SpendProcessed`] if the spend payout has succeed.
 */
export interface AmbassadorTreasuryCall_check_status {
    __kind: 'check_status'
    index: number
}
 ...
 * Emits [`Event::Paid`] if successful.
 */
export interface AmbassadorTreasuryCall_payout {
    __kind: 'payout'
    index: number
}
 ...
 *   in the first place.
 */
export interface AmbassadorTreasuryCall_remove_approval {
    __kind: 'remove_approval'
    proposalId: number
}
 ...
 * Emits [`Event::AssetSpendApproved`] if successful.
 */
export interface AmbassadorTreasuryCall_spend {
    __kind: 'spend'
    assetKind: VersionedLocatableAsset
    amount: bigint
    beneficiary: VersionedLocation
 ...
 * Emits [`Event::SpendApproved`] if successful.
 */
export interface AmbassadorTreasuryCall_spend_local {
    __kind: 'spend_local'
    amount: bigint
    beneficiary: MultiAddress
}
 ...
 * Emits [`Event::AssetSpendVoided`] if successful.
 */
export interface AmbassadorTreasuryCall_void_spend {
    __kind: 'void_spend'
    index: number
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type AmbassadorSalaryCall = AmbassadorSalaryCall_bump | AmbassadorSalaryCall_check_payment | AmbassadorSalaryCall_induct | AmbassadorSalaryCall_init | AmbassadorSalaryCall_payout | AmbassadorSalaryCall_payout_other | AmbassadorSalaryCall_register
 ...
 * - `origin`: A `Signed` origin of an account.
 */
export interface AmbassadorSalaryCall_bump {
    __kind: 'bump'
}
 ...
 *   received a payment this cycle.
 */
export interface AmbassadorSalaryCall_check_payment {
    __kind: 'check_payment'
}
 ...
 * Induct oneself into the payout system.
 */
export interface AmbassadorSalaryCall_induct {
    __kind: 'induct'
}
 ...
 * - `origin`: A `Signed` origin of an account.
 */
export interface AmbassadorSalaryCall_init {
    __kind: 'init'
}
 ...
 * - `origin`: A `Signed` origin of an account which is a member of `Members`.
 */
export interface AmbassadorSalaryCall_payout {
    __kind: 'payout'
}
 ...
 * - `beneficiary`: The account to receive payment.
 */
export interface AmbassadorSalaryCall_payout_other {
    __kind: 'payout_other'
    beneficiary: AccountId32
}
 ...
 * - `origin`: A `Signed` origin of an account which is a member of `Members`.
 */
export interface AmbassadorSalaryCall_register {
    __kind: 'register'
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type AmbassadorReferendaCall = AmbassadorReferendaCall_cancel | AmbassadorReferendaCall_kill | AmbassadorReferendaCall_nudge_referendum | AmbassadorReferendaCall_one_fewer_deciding | AmbassadorReferendaCall_place_decision_deposit | AmbassadorReferendaCall_refund_decision_deposit | AmbassadorReferendaCall_refund_submission_deposit | AmbassadorReferendaCall_set_metadata | AmbassadorReferendaCall_submit
 ...
 * Emits `Cancelled`.
 */
export interface AmbassadorReferendaCall_cancel {
    __kind: 'cancel'
    index: number
}
 ...
 * Emits `Killed` and `DepositSlashed`.
 */
export interface AmbassadorReferendaCall_kill {
    __kind: 'kill'
    index: number
}
 ...
 * - `index`: the referendum to be advanced.
 */
export interface AmbassadorReferendaCall_nudge_referendum {
    __kind: 'nudge_referendum'
    index: number
}
 ...
 * - decrement `DecidingCount`.
 */
export interface AmbassadorReferendaCall_one_fewer_deciding {
    __kind: 'one_fewer_deciding'
    track: number
}
 ...
 * Emits `DecisionDepositPlaced`.
 */
export interface AmbassadorReferendaCall_place_decision_deposit {
    __kind: 'place_decision_deposit'
    index: number
}
 ...
 * Emits `DecisionDepositRefunded`.
 */
export interface AmbassadorReferendaCall_refund_decision_deposit {
    __kind: 'refund_decision_deposit'
    index: number
}
 ...
 * Emits `SubmissionDepositRefunded`.
 */
export interface AmbassadorReferendaCall_refund_submission_deposit {
    __kind: 'refund_submission_deposit'
    index: number
}
 ...
 * - `maybe_hash`: The hash of an on-chain stored preimage. `None` to clear a metadata.
 */
export interface AmbassadorReferendaCall_set_metadata {
    __kind: 'set_metadata'
    index: number
    maybeHash?: (H256 | undefined)
}
 ...
 * Emits `Submitted`.
 */
export interface AmbassadorReferendaCall_submit {
    __kind: 'submit'
    proposalOrigin: OriginCaller
    proposal: Bounded
    enactmentMoment: DispatchTime
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type AmbassadorCoreCall = AmbassadorCoreCall_approve | AmbassadorCoreCall_bump | AmbassadorCoreCall_import | AmbassadorCoreCall_induct | AmbassadorCoreCall_offboard | AmbassadorCoreCall_promote | AmbassadorCoreCall_promote_fast | AmbassadorCoreCall_set_active | AmbassadorCoreCall_set_params | AmbassadorCoreCall_set_partial_params | AmbassadorCoreCall_submit_evidence
 ...
 * - `at_rank`: The rank of member.
 */
export interface AmbassadorCoreCall_approve {
    __kind: 'approve'
    who: AccountId32
    atRank: number
}
 ...
 * - `who`: A member account whose state is to be updated.
 */
export interface AmbassadorCoreCall_bump {
    __kind: 'bump'
    who: AccountId32
}
 ...
 * - `origin`: A signed origin of a ranked, but not tracked, account.
 */
export interface AmbassadorCoreCall_import {
    __kind: 'import'
}
 ...
 * - `who`: The account ID of the candidate to be inducted and become a member.
 */
export interface AmbassadorCoreCall_induct {
    __kind: 'induct'
    who: AccountId32
}
 ...
 *   ranked member of the collective.
 */
export interface AmbassadorCoreCall_offboard {
    __kind: 'offboard'
    who: AccountId32
}
 ...
 * - `to_rank`: One more than the current rank of `who`.
 */
export interface AmbassadorCoreCall_promote {
    __kind: 'promote'
    who: AccountId32
    toRank: number
}
 ...
 * be inducted.
 */
export interface AmbassadorCoreCall_promote_fast {
    __kind: 'promote_fast'
    who: AccountId32
    toRank: number
}
 ...
 * - `is_active`: `true` iff the member is active.
 */
export interface AmbassadorCoreCall_set_active {
    __kind: 'set_active'
    isActive: boolean
}
 ...
 * - `params`: The new parameters for the pallet.
 */
export interface AmbassadorCoreCall_set_params {
    __kind: 'set_params'
    params: ParamsType
}
 ...
 * the fields that does not need to update (set to None).
 */
export interface AmbassadorCoreCall_set_partial_params {
    __kind: 'set_partial_params'
    partialParams: Type_256
}
 ...
 *   decentralised content-based-indexing system such as IPFS.
 */
export interface AmbassadorCoreCall_submit_evidence {
    __kind: 'submit_evidence'
    wish: Wish
    evidence: Bytes
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type AmbassadorCollectiveCall = AmbassadorCollectiveCall_add_member | AmbassadorCollectiveCall_cleanup_poll | AmbassadorCollectiveCall_demote_member | AmbassadorCollectiveCall_exchange_member | AmbassadorCollectiveCall_promote_member | AmbassadorCollectiveCall_remove_member | AmbassadorCollectiveCall_vote
 ...
 * Weight: `O(1)`
 */
export interface AmbassadorCollectiveCall_add_member {
    __kind: 'add_member'
    who: MultiAddress
}
 ...
 * Weight `O(max)` (less if there are fewer items to remove than `max`).
 */
export interface AmbassadorCollectiveCall_cleanup_poll {
    __kind: 'cleanup_poll'
    pollIndex: number
    max: number
}
 ...
 * Weight: `O(1)`, less if the member's index is highest in its rank.
 */
export interface AmbassadorCollectiveCall_demote_member {
    __kind: 'demote_member'
    who: MultiAddress
}
 ...
 * - `new_who`: New Account of existing member of rank greater than zero to exchanged to.
 */
export interface AmbassadorCollectiveCall_exchange_member {
    __kind: 'exchange_member'
    who: MultiAddress
    newWho: MultiAddress
}
 ...
 * Weight: `O(1)`
 */
export interface AmbassadorCollectiveCall_promote_member {
    __kind: 'promote_member'
    who: MultiAddress
}
 ...
 * Weight: `O(min_rank)`.
 */
export interface AmbassadorCollectiveCall_remove_member {
    __kind: 'remove_member'
    who: MultiAddress
    minRank: number
}
 ...
 * Weight: `O(1)`, less if there was no previous vote on the poll by the member.
 */
export interface AmbassadorCollectiveCall_vote {
    __kind: 'vote'
    poll: number
    aye: boolean
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type AllianceMotionCall = AllianceMotionCall_close | AllianceMotionCall_disapprove_proposal | AllianceMotionCall_execute | AllianceMotionCall_propose | AllianceMotionCall_set_members | AllianceMotionCall_vote
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type AllianceCall = AllianceCall_abdicate_fellow_status | AllianceCall_add_unscrupulous_items | AllianceCall_announce | AllianceCall_close | AllianceCall_disband | AllianceCall_elevate_ally | AllianceCall_give_retirement_notice | AllianceCall_init_members | AllianceCall_join_alliance | AllianceCall_kick_member | AllianceCall_nominate_ally | AllianceCall_propose | AllianceCall_remove_announcement | AllianceCall_remove_unscrupulous_items | AllianceCall_retire | AllianceCall_set_rule | AllianceCall_vote
...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        Alliance: AllianceCall,
        AllianceMotion: AllianceMotionCall,
        AmbassadorCollective: AmbassadorCollectiveCall,
        AmbassadorCore: AmbassadorCoreCall,
        AmbassadorReferenda: AmbassadorReferendaCall,
        AmbassadorSalary: AmbassadorSalaryCall,
        AmbassadorTreasury: AmbassadorTreasuryCall,
        ...
        FellowshipCore: FellowshipCoreCall,
        FellowshipReferenda: FellowshipReferendaCall,
        FellowshipSalary: FellowshipSalaryCall,
        FellowshipTreasury: FellowshipTreasuryCall,
...
export const Type_206: sts.Type<Type_206> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_209),
        V3: sts.array(() => Type_213),
        V4: sts.array(() => Type_216),
    }
})
...
export const Type_216: sts.Type<Type_216> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V4Asset),
        SetAppendix: sts.array(() => Type_216),
        SetErrorHandler: sts.array(() => Type_216),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_213: sts.Type<Type_213> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_213),
        SetErrorHandler: sts.array(() => Type_213),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_209: sts.Type<Type_209> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_209),
        SetErrorHandler: sts.array(() => Type_209),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const FellowshipTreasuryCall: sts.Type<FellowshipTreasuryCall> = sts.closedEnum(() => {
    return  {
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const FellowshipSalaryCall: sts.Type<FellowshipSalaryCall> = sts.closedEnum(() => {
    return  {
        bump: sts.unit(),
        check_payment: sts.unit(),
        induct: sts.unit(),
        init: sts.unit(),
        payout: sts.unit(),
        payout_other: sts.enumStruct({
            beneficiary: AccountId32,
        }),
        register: sts.unit(),
    }
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const FellowshipCoreCall: sts.Type<FellowshipCoreCall> = sts.closedEnum(() => {
    return  {
        ...
        import: sts.unit(),
        induct: sts.enumStruct({
            who: AccountId32,
        }),
        offboard: sts.enumStruct({
            who: AccountId32,
        }),
        promote: sts.enumStruct({
            who: AccountId32,
            toRank: sts.number(),
        }),
        promote_fast: sts.enumStruct({
            who: AccountId32,
            toRank: sts.number(),
        }),
        set_active: sts.enumStruct({
            isActive: sts.boolean(),
        }),
        set_params: sts.enumStruct({
            params: ParamsType,
        }),
        set_partial_params: sts.enumStruct({
            partialParams: Type_256,
        }),
        submit_evidence: sts.enumStruct({
            wish: Wish,
            evidence: sts.bytes(),
        }),
    }
...
export const Wish: sts.Type<Wish> = sts.closedEnum(() => {
    return  {
        Promotion: sts.unit(),
        Retention: sts.unit(),
    }
...
export const Type_256: sts.Type<Type_256> = sts.struct(() => {
    return  {
        activeSalary: sts.array(() => sts.option(() => sts.bigint())),
        passiveSalary: sts.array(() => sts.option(() => sts.bigint())),
        demotionPeriod: sts.array(() => sts.option(() => sts.number())),
        minPromotionPeriod: sts.array(() => sts.option(() => sts.number())),
        offboardTimeout: sts.option(() => sts.number()),
    }
})
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const AmbassadorTreasuryCall: sts.Type<AmbassadorTreasuryCall> = sts.closedEnum(() => {
    return  {
        check_status: sts.enumStruct({
            index: sts.number(),
        }),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const AmbassadorSalaryCall: sts.Type<AmbassadorSalaryCall> = sts.closedEnum(() => {
    return  {
        bump: sts.unit(),
        check_payment: sts.unit(),
        induct: sts.unit(),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const AmbassadorReferendaCall: sts.Type<AmbassadorReferendaCall> = sts.closedEnum(() => {
    return  {
        cancel: sts.enumStruct({
            index: sts.number(),
        }),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const AmbassadorCoreCall: sts.Type<AmbassadorCoreCall> = sts.closedEnum(() => {
    return  {
        approve: sts.enumStruct({
            who: AccountId32,
            atRank: sts.number(),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const AmbassadorCollectiveCall: sts.Type<AmbassadorCollectiveCall> = sts.closedEnum(() => {
    return  {
        add_member: sts.enumStruct({
            who: MultiAddress,
        }),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const AllianceMotionCall: sts.Type<AllianceMotionCall> = sts.closedEnum(() => {
    return  {
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export const AllianceCall: sts.Type<AllianceCall> = sts.closedEnum(() => {
    return  {
        abdicate_fellow_status: sts.unit(),
        add_unscrupulous_items: sts.enumStruct({
            items: sts.array(() => UnscrupulousItem),
        }),
        announce: sts.enumStruct({
            announcement: Cid,
        }),
        ...
        disband: sts.enumStruct({
            witness: DisbandWitness,
        }),
        elevate_ally: sts.enumStruct({
            ally: MultiAddress,
        }),
        give_retirement_notice: sts.unit(),
        init_members: sts.enumStruct({
            fellows: sts.array(() => AccountId32),
            allies: sts.array(() => AccountId32),
        }),
        join_alliance: sts.unit(),
        kick_member: sts.enumStruct({
            who: MultiAddress,
        }),
        nominate_ally: sts.enumStruct({
            who: MultiAddress,
        }),
        propose: sts.enumStruct({
            threshold: sts.number(),
        ...
        remove_unscrupulous_items: sts.enumStruct({
            items: sts.array(() => UnscrupulousItem),
        }),
        retire: sts.unit(),
        set_rule: sts.enumStruct({
            rule: Cid,
        }),
        vote: sts.enumStruct({
            proposal: H256,
...
export const DisbandWitness: sts.Type<DisbandWitness> = sts.struct(() => {
    return  {
        fellowMembers: sts.number(),
        allyMembers: sts.number(),
    }
})

export const Cid: sts.Type<Cid> = sts.struct(() => {
    return  {
        version: Version,
        codec: sts.bigint(),
        hash: Multihash,
...
export const Multihash: sts.Type<Multihash> = sts.struct(() => {
    return  {
        code: sts.bigint(),
        digest: sts.bytes(),
    }
...
export const Version: sts.Type<Version> = sts.closedEnum(() => {
    return  {
        V0: sts.unit(),
        V1: sts.unit(),
    }
...
export const UnscrupulousItem: sts.Type<UnscrupulousItem> = sts.closedEnum(() => {
    return  {
