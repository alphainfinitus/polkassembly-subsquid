...
export const proposalOf =  {
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v8000: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v8000.H256], v8000.Call) as ProposalOfV8000,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v9000: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v9000.H256], v9000.Call) as ProposalOfV9000,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1000000: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v1000000.H256], v1000000.Call) as ProposalOfV1000000,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1001000: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v1001000.H256], v1001000.Call) as ProposalOfV1001000,
}
