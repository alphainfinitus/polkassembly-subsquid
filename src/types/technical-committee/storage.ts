...
export const proposals =  {
     ...
     */
    v63: new StorageType('TechnicalCommittee.Proposals', 'Default', [], sts.array(() => v63.H256)) as ProposalsV63,
}
...
export const proposalOf =  {
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v74: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v74.H256], v74.Call) as ProposalOfV74,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v77: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v77.H256], v77.Call) as ProposalOfV77,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v83: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v83.H256], v83.Call) as ProposalOfV83,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v84: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v84.H256], v84.Call) as ProposalOfV84,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v86: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v86.H256], v86.Call) as ProposalOfV86,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v89: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v89.H256], v89.Call) as ProposalOfV89,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v91: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v91.H256], v91.Call) as ProposalOfV91,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v96: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v96.H256], v96.Call) as ProposalOfV96,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v98: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v98.H256], v98.Call) as ProposalOfV98,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v101: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v101.H256], v101.Call) as ProposalOfV101,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v105: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v105.H256], v105.Call) as ProposalOfV105,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v107: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v107.H256], v107.Call) as ProposalOfV107,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v109: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v109.H256], v109.Call) as ProposalOfV109,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v110: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v110.H256], v110.Call) as ProposalOfV110,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v112: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v112.H256], v112.Call) as ProposalOfV112,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v113: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v113.H256], v113.Call) as ProposalOfV113,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v115: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v115.H256], v115.Call) as ProposalOfV115,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v118: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v118.H256], v118.Call) as ProposalOfV118,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v119: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v119.H256], v119.Call) as ProposalOfV119,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v122: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v122.H256], v122.Call) as ProposalOfV122,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v123: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v123.H256], v123.Call) as ProposalOfV123,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v125: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v125.H256], v125.Call) as ProposalOfV125,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v126: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v126.H256], v126.Call) as ProposalOfV126,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v133: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v133.H256], v133.Call) as ProposalOfV133,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v136: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v136.H256], v136.Call) as ProposalOfV136,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v137: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v137.H256], v137.Call) as ProposalOfV137,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v1200: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v1200.H256], v1200.Call) as ProposalOfV1200,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1300: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v1300.H256], v1300.Call) as ProposalOfV1300,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1401: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v1401.H256], v1401.Call) as ProposalOfV1401,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1500: new StorageType('TechnicalCommittee.ProposalOf', 'Optional', [v1500.H256], v1500.Call) as ProposalOfV1500,
}
...
export const voting =  {
     ...
     */
    v63: new StorageType('TechnicalCommittee.Voting', 'Optional', [v63.H256], v63.Votes) as VotingV63,
}
...
export const proposalCount =  {
     ...
     *  Proposals so far.
     */
    v63: new StorageType('TechnicalCommittee.ProposalCount', 'Default', [], sts.number()) as ProposalCountV63,
}
...
export const members =  {
     ...
     */
    v63: new StorageType('TechnicalCommittee.Members', 'Default', [], sts.array(() => v63.AccountId32)) as MembersV63,
}
