...
export type Call = Call_Assets | Call_Balances | Call_CollatorSelection | Call_Contracts | Call_Council | Call_CumulusXcm | Call_DappStaking | Call_DappStakingMigration | Call_Democracy | Call_DmpQueue | Call_DynamicEvmBaseFee | Call_EVM | Call_Ethereum | Call_EthereumChecked | Call_Identity | Call_Inflation | Call_Multisig | Call_Oracle | Call_OracleMembership | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Scheduler | Call_Session | Call_StaticPriceProvider | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_Timestamp | Call_Treasury | Call_UnifiedAccounts | Call_Utility | Call_Vesting | Call_XTokens | Call_XcAssetConfig | Call_XcmpQueue
...
export type Type_333 = Type_333_XcmEthereumTx

export interface Type_333_XcmEthereumTx {
    __kind: 'XcmEthereumTx'
    value: AccountId32
}

export type Type_332 = Type_332_EthereumTransaction

export interface Type_332_EthereumTransaction {
...
export type Type_276 = Type_276_V2 | Type_276_V3

export interface Type_276_V2 {
    __kind: 'V2'
    value: Type_279[]
}

export interface Type_276_V3 {
    __kind: 'V3'
    value: Type_283[]
}

export type Type_283 = Type_283_AliasOrigin | Type_283_BurnAsset | Type_283_BuyExecution | Type_283_ClaimAsset | Type_283_ClearError | Type_283_ClearOrigin | Type_283_ClearTopic | Type_283_ClearTransactStatus | Type_283_DepositAsset | Type_283_DepositReserveAsset | Type_283_DescendOrigin | Type_283_ExchangeAsset | Type_283_ExpectAsset | Type_283_ExpectError | Type_283_ExpectOrigin | Type_283_ExpectPallet | Type_283_ExpectTransactStatus | Type_283_ExportMessage | Type_283_HrmpChannelAccepted | Type_283_HrmpChannelClosing | Type_283_HrmpNewChannelOpenRequest | Type_283_InitiateReserveWithdraw | Type_283_InitiateTeleport | Type_283_LockAsset | Type_283_NoteUnlockable | Type_283_QueryPallet | Type_283_QueryResponse | Type_283_ReceiveTeleportedAsset | Type_283_RefundSurplus | Type_283_ReportError | Type_283_ReportHolding | Type_283_ReportTransactStatus | Type_283_RequestUnlock | Type_283_ReserveAssetDeposited | Type_283_SetAppendix | Type_283_SetErrorHandler | Type_283_SetFeesMode | Type_283_SetTopic | Type_283_SubscribeVersion | Type_283_Transact | Type_283_TransferAsset | Type_283_TransferReserveAsset | Type_283_Trap | Type_283_UniversalOrigin | Type_283_UnlockAsset | Type_283_UnpaidExecution | Type_283_UnsubscribeVersion | Type_283_WithdrawAsset

export interface Type_283_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_283_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_283_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_283_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_283_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_283_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_283_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_283_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_283_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_283_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_283_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_283_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_283_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_283_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_283_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_283_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_283_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_283_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_283_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_283_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_283_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export type Type_279 = Type_279_BuyExecution | Type_279_ClaimAsset | Type_279_ClearError | Type_279_ClearOrigin | Type_279_DepositAsset | Type_279_DepositReserveAsset | Type_279_DescendOrigin | Type_279_ExchangeAsset | Type_279_HrmpChannelAccepted | Type_279_HrmpChannelClosing | Type_279_HrmpNewChannelOpenRequest | Type_279_InitiateReserveWithdraw | Type_279_InitiateTeleport | Type_279_QueryHolding | Type_279_QueryResponse | Type_279_ReceiveTeleportedAsset | Type_279_RefundSurplus | Type_279_ReportError | Type_279_ReserveAssetDeposited | Type_279_SetAppendix | Type_279_SetErrorHandler | Type_279_SubscribeVersion | Type_279_Transact | Type_279_TransferAsset | Type_279_TransferReserveAsset | Type_279_Trap | Type_279_UnsubscribeVersion | Type_279_WithdrawAsset
...
export const Type_276: sts.Type<Type_276> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_279),
        V3: sts.array(() => Type_283),
    }
})
...
export const Type_279: sts.Type<Type_279> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_279),
        SetErrorHandler: sts.array(() => Type_279),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
