...
export type Type_166 = Type_166_Member | Type_166_Members | Type_166__Phantom

export interface Type_166_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_166_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_166__Phantom {
    __kind: '_Phantom'
}

export type Type_165 = Type_165_Member | Type_165_Members | Type_165__Phantom

export interface Type_165_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_165_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_165__Phantom {
    __kind: '_Phantom'
}
...
export type StatefulStorageCall = StatefulStorageCall_apply_item_actions | StatefulStorageCall_apply_item_actions_with_signature | StatefulStorageCall_apply_item_actions_with_signature_v2 | StatefulStorageCall_delete_page | StatefulStorageCall_delete_page_with_signature | StatefulStorageCall_delete_page_with_signature_v2 | StatefulStorageCall_upsert_page | StatefulStorageCall_upsert_page_with_signature | StatefulStorageCall_upsert_page_with_signature_v2
...
export type SchemasCall = SchemasCall_create_schema | SchemasCall_create_schema_name_via_governance | SchemasCall_create_schema_v2 | SchemasCall_create_schema_v3 | SchemasCall_create_schema_via_governance | SchemasCall_create_schema_via_governance_v2 | SchemasCall_propose_to_create_schema | SchemasCall_propose_to_create_schema_name | SchemasCall_propose_to_create_schema_v2 | SchemasCall_set_max_schema_model_bytes
...
export interface SchemasCall_create_schema_v2 {
    __kind: 'create_schema_v2'
    model: Bytes
    modelType: ModelType
    payloadLocation: PayloadLocation
...
export type PasskeyCall = PasskeyCall_proxy
...
export const SchemasCall: sts.Type<SchemasCall> = sts.closedEnum(() => {
    return  {
        ...
        create_schema_v2: sts.enumStruct({
            model: sts.bytes(),
            modelType: ModelType,
            payloadLocation: PayloadLocation,
