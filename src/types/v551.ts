...
export type Type_283 = Type_283_Relay | Type_283_SiblingParachain

export interface Type_283_Relay {
    __kind: 'Relay'
}

export interface Type_283_SiblingParachain {
