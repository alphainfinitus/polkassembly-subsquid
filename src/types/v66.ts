...
export type Type_297 = Type_297_EthereumTransaction

export interface Type_297_EthereumTransaction {
...
export type Type_296 = Type_296_Relay | Type_296_SiblingParachain

export interface Type_296_Relay {
    __kind: 'Relay'
}

export interface Type_296_SiblingParachain {
