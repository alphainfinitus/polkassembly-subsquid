...
export type Call = Call_Balances | Call_ContributionTokens | Call_Council | Call_CumulusXcm | Call_Democracy | Call_Dispenser | Call_Elections | Call_ForeignAssets | Call_Funding | Call_Identity | Call_LinearRelease | Call_MessageQueue | Call_Multisig | Call_Oracle | Call_OracleProvidersMembership | Call_ParachainInfo | Call_ParachainStaking | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_ProxyBonding | Call_Scheduler | Call_Session | Call_System | Call_TechnicalCommittee | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting | Call_XcmpQueue
...
export type Type_395 = Type_395_Relay | Type_395_SiblingParachain

export interface Type_395_Relay {
    __kind: 'Relay'
}

export interface Type_395_SiblingParachain {
...
export type RuntimeHoldReason = RuntimeHoldReason_Democracy | RuntimeHoldReason_Elections | RuntimeHoldReason_Funding | RuntimeHoldReason_ParachainStaking | RuntimeHoldReason_Preimage
...
export type Type_388 = Type_388_Preimage

export interface Type_388_Preimage {
    __kind: 'Preimage'
}
...
export type Type_389 = Type_389_Evaluation | Type_389_Participation

export interface Type_389_Evaluation {
    __kind: 'Evaluation'
}

export interface Type_389_Participation {
    __kind: 'Participation'
}

export type Type_387 = Type_387_Candidacy

export interface Type_387_Candidacy {
    __kind: 'Candidacy'
}

export type Type_386 = Type_386_Proposal

export interface Type_386_Proposal {
    __kind: 'Proposal'
}
...
export type Type = Type_Any | Type_Governance | Type_IdentityJudgement | Type_NonTransfer | Type_Staking
...
export interface Type_IdentityJudgement {
...
export type Type_350 = Type_350_V2 | Type_350_V3 | Type_350_V4

export interface Type_350_V2 {
    __kind: 'V2'
    value: Type_353[]
}
...
export type Type_353 = Type_353_BuyExecution | Type_353_ClaimAsset | Type_353_ClearError | Type_353_ClearOrigin | Type_353_DepositAsset | Type_353_DepositReserveAsset | Type_353_DescendOrigin | Type_353_ExchangeAsset | Type_353_HrmpChannelAccepted | Type_353_HrmpChannelClosing | Type_353_HrmpNewChannelOpenRequest | Type_353_InitiateReserveWithdraw | Type_353_InitiateTeleport | Type_353_QueryHolding | Type_353_QueryResponse | Type_353_ReceiveTeleportedAsset | Type_353_RefundSurplus | Type_353_ReportError | Type_353_ReserveAssetDeposited | Type_353_SetAppendix | Type_353_SetErrorHandler | Type_353_SubscribeVersion | Type_353_Transact | Type_353_TransferAsset | Type_353_TransferReserveAsset | Type_353_Trap | Type_353_UnsubscribeVersion | Type_353_WithdrawAsset
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type FundingCall = FundingCall_bid | FundingCall_confirm_offchain_migration | FundingCall_confirm_pallet_migrations | FundingCall_contribute | FundingCall_create_project | FundingCall_edit_project | FundingCall_end_auction | FundingCall_end_evaluation | FundingCall_end_funding | FundingCall_evaluate | FundingCall_mark_project_as_settled | FundingCall_mark_project_ct_migration_as_finished | FundingCall_pallet_migration_readiness_response | FundingCall_remove_project | FundingCall_send_pallet_migration_for | FundingCall_settle_bid | FundingCall_settle_contribution | FundingCall_settle_evaluation | FundingCall_start_evaluation | FundingCall_start_offchain_migration | FundingCall_start_pallet_migration | FundingCall_start_pallet_migration_readiness_check | FundingCall_start_settlement
...
export interface FundingCall_confirm_pallet_migrations {
    __kind: 'confirm_pallet_migrations'
    queryId: bigint
    response: V4Response
}
 ...
 */
export interface FundingCall_contribute {
    __kind: 'contribute'
    jwt: UntrustedToken
    projectId: number
    ctAmount: bigint
...
export interface FundingCall_end_auction {
    __kind: 'end_auction'
    projectId: number
}
 ...
 */
export interface FundingCall_pallet_migration_readiness_response {
    __kind: 'pallet_migration_readiness_response'
    queryId: bigint
    response: V4Response
}
...
export interface FundingCall_send_pallet_migration_for {
    __kind: 'send_pallet_migration_for'
    projectId: number
    participant: AccountId32
}
...
export interface FundingCall_settle_contribution {
    __kind: 'settle_contribution'
    projectId: number
...
export interface FundingCall_start_pallet_migration {
    __kind: 'start_pallet_migration'
    jwt: UntrustedToken
    projectId: number
    paraId: Id
}

export interface FundingCall_start_pallet_migration_readiness_check {
    __kind: 'start_pallet_migration_readiness_check'
    jwt: UntrustedToken
    projectId: number
}
...
export type AcceptedFundingAsset = AcceptedFundingAsset_DOT | AcceptedFundingAsset_USDC | AcceptedFundingAsset_USDT
...
export interface Header {
    ...
    certificateThumbprint?: (Type_313 | undefined)
    tokenType?: (string | undefined)
}

export type Type_313 = Type_313_Bytes | Type_313_String

export interface Type_313_Bytes {
    __kind: 'Bytes'
    value: Bytes
}

export interface Type_313_String {
    __kind: 'String'
    value: string
}
...
export const Type_350: sts.Type<Type_350> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_353),
        V3: sts.array(() => Type_357),
        V4: sts.array(() => Type_360),
    }
})
...
export const OracleCall: sts.Type<OracleCall> = sts.closedEnum(() => {
    return  {
        feed_values: sts.enumStruct({
            values: sts.array(() => sts.tuple(() => [sts.number(), FixedU128])),
        }),
    }
})
...
export const FundingCall: sts.Type<FundingCall> = sts.closedEnum(() => {
    return  {
        ...
        confirm_pallet_migrations: sts.enumStruct({
            queryId: sts.bigint(),
            response: V4Response,
        }),
        ...
        pallet_migration_readiness_response: sts.enumStruct({
            queryId: sts.bigint(),
            response: V4Response,
        }),
        ...
        send_pallet_migration_for: sts.enumStruct({
            projectId: sts.number(),
            participant: AccountId32,
        }),
        ...
        settle_contribution: sts.enumStruct({
            projectId: sts.number(),
            contributor: AccountId32,
            contributionId: sts.number(),
        }),
        ...
        start_pallet_migration: sts.enumStruct({
            jwt: UntrustedToken,
            projectId: sts.number(),
            paraId: Id,
        }),
        start_pallet_migration_readiness_check: sts.enumStruct({
            jwt: UntrustedToken,
            projectId: sts.number(),
        }),
...
export const ContributingTicketSizes: sts.Type<ContributingTicketSizes> = sts.struct(() => {
    return  {
        retail: TicketSize,
        professional: TicketSize,
        institutional: TicketSize,
...
export const Header: sts.Type<Header> = sts.struct(() => {
    return  {
        ...
        certificateThumbprint: sts.option(() => Type_313),
