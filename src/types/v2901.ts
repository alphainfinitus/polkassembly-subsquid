...
export type Type_186 = Type_186_Member | Type_186_Members | Type_186__Phantom

export interface Type_186_Member {
    __kind: 'Member'
    value: AccountId20
}

export interface Type_186_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_186__Phantom {
    __kind: '_Phantom'
}

export type Type_184 = Type_184_Response | Type_184_Xcm

export interface Type_184_Response {
    __kind: 'Response'
    value: V4Location
}

export interface Type_184_Xcm {
    __kind: 'Xcm'
    value: V4Location
}
...
export type Type_187 = Type_187_FastGeneralAdmin | Type_187_GeneralAdmin | Type_187_ReferendumCanceller | Type_187_ReferendumKiller | Type_187_WhitelistedCaller

export interface Type_187_FastGeneralAdmin {
    __kind: 'FastGeneralAdmin'
}

export interface Type_187_GeneralAdmin {
    __kind: 'GeneralAdmin'
}

export interface Type_187_ReferendumCanceller {
    __kind: 'ReferendumCanceller'
}

export interface Type_187_ReferendumKiller {
    __kind: 'ReferendumKiller'
}

export interface Type_187_WhitelistedCaller {
...
export type Type_185 = Type_185_XcmEthereumTransaction

export interface Type_185_XcmEthereumTransaction {
...
export type Type_182 = Type_182_EthereumTransaction

export interface Type_182_EthereumTransaction {
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        CumulusXcm: Origin,
        Ethereum: Type_182,
        EthereumXcm: Type_185,
        OpenTechCommitteeCollective: Type_188,
        Origins: Type_187,
        PolkadotXcm: Type_184,
        TreasuryCouncilCollective: Type_186,
        Void: Void,
        system: RawOrigin,
    }
})
