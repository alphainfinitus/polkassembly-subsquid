...
export type Type_327 = Type_327_EthereumTransaction

export interface Type_327_EthereumTransaction {
...
export type Type_326 = Type_326_Relay | Type_326_SiblingParachain

export interface Type_326_Relay {
    __kind: 'Relay'
}

export interface Type_326_SiblingParachain {
