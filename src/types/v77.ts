...
export type Call = Call_Assets | Call_Authorship | Call_Balances | Call_BaseFee | Call_BlockReward | Call_CollatorSelection | Call_Contracts | Call_Council | Call_CumulusXcm | Call_DappsStaking | Call_Democracy | Call_DmpQueue | Call_EVM | Call_EthCall | Call_Ethereum | Call_Identity | Call_Multisig | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Proxy | Call_Scheduler | Call_Session | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting | Call_XcAssetConfig | Call_XcmpQueue | Call_Xvm
...
export type Type_301 = Type_301_EthereumTransaction

export interface Type_301_EthereumTransaction {
...
export type ProxyType = ProxyType_Any | ProxyType_CancelProxy | ProxyType_DappsStaking | ProxyType_Governance | ProxyType_IdentityJudgement | ProxyType_NonTransfer
...
export type Type_254 = Type_254_V0 | Type_254_V1 | Type_254_V2

export interface Type_254_V0 {
    __kind: 'V0'
    value: Type_255
}

export interface Type_254_V1 {
    __kind: 'V1'
    value: Type_260
}

export interface Type_254_V2 {
    __kind: 'V2'
    value: Type_266[]
}
...
export type Type_260 = Type_260_HrmpChannelAccepted | Type_260_HrmpChannelClosing | Type_260_HrmpNewChannelOpenRequest | Type_260_QueryResponse | Type_260_ReceiveTeleportedAsset | Type_260_RelayedFrom | Type_260_ReserveAssetDeposited | Type_260_SubscribeVersion | Type_260_Transact | Type_260_TransferAsset | Type_260_TransferReserveAsset | Type_260_UnsubscribeVersion | Type_260_WithdrawAsset
...
export interface Type_260_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_260
}
...
export type Type_262 = Type_262_BuyExecution | Type_262_DepositAsset | Type_262_DepositReserveAsset | Type_262_ExchangeAsset | Type_262_InitiateReserveWithdraw | Type_262_InitiateTeleport | Type_262_Noop | Type_262_QueryHolding

export interface Type_262_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weight: bigint
    debt: bigint
    haltOnError: boolean
    instructions: Type_260[]
}

export interface Type_262_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_262_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_262_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_262_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    effects: V1Order[]
...
export interface Type_262_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_262_Noop {
    __kind: 'Noop'
}

export interface Type_262_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export type Type_255 = Type_255_HrmpChannelAccepted | Type_255_HrmpChannelClosing | Type_255_HrmpNewChannelOpenRequest | Type_255_QueryResponse | Type_255_RelayedFrom | Type_255_ReserveAssetDeposit | Type_255_TeleportAsset | Type_255_Transact | Type_255_TransferAsset | Type_255_TransferReserveAsset | Type_255_WithdrawAsset
...
export interface Type_255_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V0MultiLocation
    message: Type_255
}

export interface Type_255_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_257[]
}

export interface Type_255_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_257[]
}
...
export type Type_257 = Type_257_BuyExecution | Type_257_DepositAsset | Type_257_DepositReserveAsset | Type_257_ExchangeAsset | Type_257_InitiateReserveWithdraw | Type_257_InitiateTeleport | Type_257_Null | Type_257_QueryHolding
...
export interface Type_257_Null {
    __kind: 'Null'
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ContractsCall = ContractsCall_call | ContractsCall_instantiate | ContractsCall_instantiate_with_code | ContractsCall_remove_code | ContractsCall_set_code | ContractsCall_upload_code
...
export const Type_259: sts.Type<Type_259> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export const Type_262: sts.Type<Type_262> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_260),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
