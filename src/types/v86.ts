...
export type Type_307 = Type_307_EthereumTransaction

export interface Type_307_EthereumTransaction {
...
export type Type_306 = Type_306_Relay | Type_306_SiblingParachain

export interface Type_306_Relay {
    __kind: 'Relay'
}

export interface Type_306_SiblingParachain {
...
export type Type_253 = Type_253_V0 | Type_253_V1 | Type_253_V2

export interface Type_253_V0 {
    __kind: 'V0'
    value: Type_254
}

export interface Type_253_V1 {
    __kind: 'V1'
    value: Type_259
}

export interface Type_253_V2 {
    __kind: 'V2'
    value: Type_265[]
}
...
export type Type_259 = Type_259_HrmpChannelAccepted | Type_259_HrmpChannelClosing | Type_259_HrmpNewChannelOpenRequest | Type_259_QueryResponse | Type_259_ReceiveTeleportedAsset | Type_259_RelayedFrom | Type_259_ReserveAssetDeposited | Type_259_SubscribeVersion | Type_259_Transact | Type_259_TransferAsset | Type_259_TransferReserveAsset | Type_259_UnsubscribeVersion | Type_259_WithdrawAsset
...
export interface Type_259_RelayedFrom {
    __kind: 'RelayedFrom'
    who: V1Junctions
    message: Type_259
}
...
export type Type_261 = Type_261_BuyExecution | Type_261_DepositAsset | Type_261_DepositReserveAsset | Type_261_ExchangeAsset | Type_261_InitiateReserveWithdraw | Type_261_InitiateTeleport | Type_261_Noop | Type_261_QueryHolding

export interface Type_261_BuyExecution {
    __kind: 'BuyExecution'
    fees: V1MultiAsset
    weight: bigint
    debt: bigint
    haltOnError: boolean
    instructions: Type_259[]
}

export interface Type_261_DepositAsset {
    __kind: 'DepositAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    beneficiary: V1MultiLocation
...
export interface Type_261_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V1MultiAssetFilter
    maxAssets: number
    dest: V1MultiLocation
...
export interface Type_261_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V1MultiAssetFilter
    receive: V1MultiAsset[]
}

export interface Type_261_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V1MultiAssetFilter
    reserve: V1MultiLocation
    effects: V1Order[]
...
export interface Type_261_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V1MultiAssetFilter
    dest: V1MultiLocation
    effects: V1Order[]
...
export interface Type_261_Noop {
    __kind: 'Noop'
}

export interface Type_261_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V1MultiLocation
    assets: V1MultiAssetFilter
...
export type Type_254 = Type_254_HrmpChannelAccepted | Type_254_HrmpChannelClosing | Type_254_HrmpNewChannelOpenRequest | Type_254_QueryResponse | Type_254_RelayedFrom | Type_254_ReserveAssetDeposit | Type_254_TeleportAsset | Type_254_Transact | Type_254_TransferAsset | Type_254_TransferReserveAsset | Type_254_WithdrawAsset
...
export interface Type_254_ReserveAssetDeposit {
    __kind: 'ReserveAssetDeposit'
    assets: V0MultiAsset[]
    effects: Type_256[]
}

export interface Type_254_TeleportAsset {
    __kind: 'TeleportAsset'
    assets: V0MultiAsset[]
    effects: Type_256[]
}
...
export type Type_256 = Type_256_BuyExecution | Type_256_DepositAsset | Type_256_DepositReserveAsset | Type_256_ExchangeAsset | Type_256_InitiateReserveWithdraw | Type_256_InitiateTeleport | Type_256_Null | Type_256_QueryHolding
...
export interface Type_256_Null {
    __kind: 'Null'
}
...
export const Type_261: sts.Type<Type_261> = sts.closedEnum(() => {
    return  {
        BuyExecution: sts.enumStruct({
            ...
            debt: sts.bigint(),
            haltOnError: sts.boolean(),
            instructions: sts.array(() => Type_259),
        }),
        DepositAsset: sts.enumStruct({
            assets: V1MultiAssetFilter,
            maxAssets: sts.number(),
