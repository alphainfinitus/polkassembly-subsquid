...
export type Type_412 = Type_412_Member | Type_412_Members | Type_412__Phantom

export interface Type_412_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_412_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_412__Phantom {
    __kind: '_Phantom'
}

export type Type_407 = Type_407_Response | Type_407_Xcm

export interface Type_407_Response {
    __kind: 'Response'
    value: V4Location
}

export interface Type_407_Xcm {
    __kind: 'Xcm'
    value: V4Location
}

export type Type_410 = Type_410_XcmEthereumTx

export interface Type_410_XcmEthereumTx {
    __kind: 'XcmEthereumTx'
    value: AccountId32
}

export type Type_409 = Type_409_EthereumTransaction

export interface Type_409_EthereumTransaction {
...
export type Type_408 = Type_408_Relay | Type_408_SiblingParachain

export interface Type_408_Relay {
    __kind: 'Relay'
}

export interface Type_408_SiblingParachain {
...
export type Type_411 = Type_411_Member | Type_411_Members | Type_411__Phantom

export interface Type_411_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_411_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_411__Phantom {
    __kind: '_Phantom'
}
...
export type Type_335 = Type_335_V2 | Type_335_V3 | Type_335_V4
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        CommunityCouncil: Type_413,
        Council: Type_411,
        CumulusXcm: Type_408,
        Ethereum: Type_409,
        EthereumChecked: Type_410,
        PolkadotXcm: Type_407,
        TechnicalCommittee: Type_412,
        Void: Void,
        system: RawOrigin,
    }
})
