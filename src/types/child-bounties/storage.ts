...
export const childBounties =  {
     ...
     */
    v1009001: new StorageType('ChildBounties.ChildBounties', 'Optional', [sts.number(), sts.number()], v1009001.ChildBounty) as ChildBountiesV1009001,
}

/**
 *  Child bounties that have been added.
 */
export interface ChildBountiesV1009001  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key1: number, key2: number): Promise<(v1009001.ChildBounty | undefined)>
    getMany(block: Block, keys: [number, number][]): Promise<(v1009001.ChildBounty | undefined)[]>
    ...
    getPairs(block: Block): Promise<[k: [number, number], v: (v1009001.ChildBounty | undefined)][]>
    getPairs(block: Block, key1: number): Promise<[k: [number, number], v: (v1009001.ChildBounty | undefined)][]>
    getPairs(block: Block, key1: number, key2: number): Promise<[k: [number, number], v: (v1009001.ChildBounty | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: [number, number], v: (v1009001.ChildBounty | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: number): AsyncIterable<[k: [number, number], v: (v1009001.ChildBounty | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: number, key2: number): AsyncIterable<[k: [number, number], v: (v1009001.ChildBounty | undefined)][]>
}
...
export const childBountyDescriptionsV1 =  {
     ...
     */
    v1009001: new StorageType('ChildBounties.ChildBountyDescriptionsV1', 'Optional', [sts.number(), sts.number()], sts.bytes()) as ChildBountyDescriptionsV1V1009001,
}
 ...
 *  This item replaces the `ChildBountyDescriptions` storage item from the V0 storage version.
 */
export interface ChildBountyDescriptionsV1V1009001  {
    is(block: RuntimeCtx): boolean
