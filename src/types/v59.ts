...
export type Type_358 = Type_358_V2 | Type_358_V3
...
export interface Type_358_V3 {
    __kind: 'V3'
    value: Type_365[]
}

export type Type_365 = Type_365_AliasOrigin | Type_365_BurnAsset | Type_365_BuyExecution | Type_365_ClaimAsset | Type_365_ClearError | Type_365_ClearOrigin | Type_365_ClearTopic | Type_365_ClearTransactStatus | Type_365_DepositAsset | Type_365_DepositReserveAsset | Type_365_DescendOrigin | Type_365_ExchangeAsset | Type_365_ExpectAsset | Type_365_ExpectError | Type_365_ExpectOrigin | Type_365_ExpectPallet | Type_365_ExpectTransactStatus | Type_365_ExportMessage | Type_365_HrmpChannelAccepted | Type_365_HrmpChannelClosing | Type_365_HrmpNewChannelOpenRequest | Type_365_InitiateReserveWithdraw | Type_365_InitiateTeleport | Type_365_LockAsset | Type_365_NoteUnlockable | Type_365_QueryPallet | Type_365_QueryResponse | Type_365_ReceiveTeleportedAsset | Type_365_RefundSurplus | Type_365_ReportError | Type_365_ReportHolding | Type_365_ReportTransactStatus | Type_365_RequestUnlock | Type_365_ReserveAssetDeposited | Type_365_SetAppendix | Type_365_SetErrorHandler | Type_365_SetFeesMode | Type_365_SetTopic | Type_365_SubscribeVersion | Type_365_Transact | Type_365_TransferAsset | Type_365_TransferReserveAsset | Type_365_Trap | Type_365_UniversalOrigin | Type_365_UnlockAsset | Type_365_UnpaidExecution | Type_365_UnsubscribeVersion | Type_365_WithdrawAsset

export interface Type_365_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_365_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_365_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_365_ClearError {
    __kind: 'ClearError'
}

export interface Type_365_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_365_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_365_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_365_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}
...
export interface Type_365_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_365_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_365_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_365_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_365_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_365_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_365_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_365_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_365_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_365_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_365_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_365_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}

export interface Type_365_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V3Response
    maxWeight: Weight
...
export interface Type_365_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_365_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_365_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_365_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_365_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_365_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_365_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_365_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_365[]
}

export interface Type_365_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_365[]
}

export interface Type_365_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_365_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_365_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}

export interface Type_365_Transact {
    __kind: 'Transact'
    originKind: V2OriginKind
    requireWeightAtMost: Weight
    call: Type_362
...
export interface Type_365_TransferAsset {
    __kind: 'TransferAsset'
    assets: V3MultiAsset[]
    beneficiary: V3MultiLocation
}

export interface Type_365_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V3MultiAsset[]
    dest: V3MultiLocation
    xcm: V3Instruction[]
...
export interface Type_365_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_365_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_365_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_365_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}

export interface Type_365_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_365_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V3MultiAsset[]
}
...
export type Type_361 = Type_361_BuyExecution | Type_361_ClaimAsset | Type_361_ClearError | Type_361_ClearOrigin | Type_361_DepositAsset | Type_361_DepositReserveAsset | Type_361_DescendOrigin | Type_361_ExchangeAsset | Type_361_HrmpChannelAccepted | Type_361_HrmpChannelClosing | Type_361_HrmpNewChannelOpenRequest | Type_361_InitiateReserveWithdraw | Type_361_InitiateTeleport | Type_361_QueryHolding | Type_361_QueryResponse | Type_361_ReceiveTeleportedAsset | Type_361_RefundSurplus | Type_361_ReportError | Type_361_ReserveAssetDeposited | Type_361_SetAppendix | Type_361_SetErrorHandler | Type_361_SubscribeVersion | Type_361_Transact | Type_361_TransferAsset | Type_361_TransferReserveAsset | Type_361_Trap | Type_361_UnsubscribeVersion | Type_361_WithdrawAsset
...
export const Type_358: sts.Type<Type_358> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_361),
        V3: sts.array(() => Type_365),
    }
})
...
export const Type_365: sts.Type<Type_365> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_365),
        SetErrorHandler: sts.array(() => Type_365),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
