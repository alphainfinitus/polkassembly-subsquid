...
export type OriginCaller = OriginCaller_CumulusXcm | OriginCaller_Ethereum | OriginCaller_EthereumXcm | OriginCaller_OpenTechCommitteeCollective | OriginCaller_Origins | OriginCaller_PolkadotXcm | OriginCaller_TreasuryCouncilCollective | OriginCaller_system
...
export type Type_205 = Type_205_Member | Type_205_Members | Type_205__Phantom
...
export type Type_206 = Type_206_FastGeneralAdmin | Type_206_GeneralAdmin | Type_206_ReferendumCanceller | Type_206_ReferendumKiller | Type_206_WhitelistedCaller

export interface Type_206_FastGeneralAdmin {
    __kind: 'FastGeneralAdmin'
}

export interface Type_206_GeneralAdmin {
    __kind: 'GeneralAdmin'
}

export interface Type_206_ReferendumCanceller {
    __kind: 'ReferendumCanceller'
}

export interface Type_206_ReferendumKiller {
    __kind: 'ReferendumKiller'
}

export interface Type_206_WhitelistedCaller {
    __kind: 'WhitelistedCaller'
}

export type Type_207 = Type_207_Member | Type_207_Members | Type_207__Phantom
...
export type Type_204 = Type_204_XcmEthereumTransaction

export interface Type_204_XcmEthereumTransaction {
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        CumulusXcm: Origin,
        Ethereum: Type_201,
        EthereumXcm: Type_204,
        OpenTechCommitteeCollective: Type_207,
        Origins: Type_206,
        PolkadotXcm: Type_203,
        TreasuryCouncilCollective: Type_205,
        system: RawOrigin,
    }
})
