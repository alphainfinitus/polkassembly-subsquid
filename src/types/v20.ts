...
export type Type_335 = Type_335_Response | Type_335_Xcm

export interface Type_335_Response {
    __kind: 'Response'
    value: V3MultiLocation
}

export interface Type_335_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}

export type Type_336 = Type_336_Relay | Type_336_SiblingParachain

export interface Type_336_Relay {
    __kind: 'Relay'
}

export interface Type_336_SiblingParachain {
...
export type Type_333 = Type_333_Member | Type_333_Members | Type_333__Phantom

export interface Type_333_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_333_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_333__Phantom {
    __kind: '_Phantom'
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        Council: Type_333,
        CumulusXcm: Type_336,
        PolkadotXcm: Type_335,
        TechnicalCommittee: Type_334,
        Void: Void,
        system: RawOrigin,
    }
})
