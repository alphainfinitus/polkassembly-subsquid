...
export type Type_299 = Type_299_Relay | Type_299_SiblingParachain

export interface Type_299_Relay {
    __kind: 'Relay'
}

export interface Type_299_SiblingParachain {
