...
export type Type_305 = Type_305_EthereumTransaction

export interface Type_305_EthereumTransaction {
...
export type Type_304 = Type_304_Relay | Type_304_SiblingParachain

export interface Type_304_Relay {
    __kind: 'Relay'
}

export interface Type_304_SiblingParachain {
