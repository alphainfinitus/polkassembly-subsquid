...
export type Type_306 = Type_306_Response | Type_306_Xcm

export interface Type_306_Response {
    __kind: 'Response'
    value: V3MultiLocation
}

export interface Type_306_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}
...
export type Type_361 = Type_361_V2 | Type_361_V3
...
export interface Type_361_V3 {
    __kind: 'V3'
    value: Type_368[]
}

export type Type_368 = Type_368_AliasOrigin | Type_368_BurnAsset | Type_368_BuyExecution | Type_368_ClaimAsset | Type_368_ClearError | Type_368_ClearOrigin | Type_368_ClearTopic | Type_368_ClearTransactStatus | Type_368_DepositAsset | Type_368_DepositReserveAsset | Type_368_DescendOrigin | Type_368_ExchangeAsset | Type_368_ExpectAsset | Type_368_ExpectError | Type_368_ExpectOrigin | Type_368_ExpectPallet | Type_368_ExpectTransactStatus | Type_368_ExportMessage | Type_368_HrmpChannelAccepted | Type_368_HrmpChannelClosing | Type_368_HrmpNewChannelOpenRequest | Type_368_InitiateReserveWithdraw | Type_368_InitiateTeleport | Type_368_LockAsset | Type_368_NoteUnlockable | Type_368_QueryPallet | Type_368_QueryResponse | Type_368_ReceiveTeleportedAsset | Type_368_RefundSurplus | Type_368_ReportError | Type_368_ReportHolding | Type_368_ReportTransactStatus | Type_368_RequestUnlock | Type_368_ReserveAssetDeposited | Type_368_SetAppendix | Type_368_SetErrorHandler | Type_368_SetFeesMode | Type_368_SetTopic | Type_368_SubscribeVersion | Type_368_Transact | Type_368_TransferAsset | Type_368_TransferReserveAsset | Type_368_Trap | Type_368_UniversalOrigin | Type_368_UnlockAsset | Type_368_UnpaidExecution | Type_368_UnsubscribeVersion | Type_368_WithdrawAsset

export interface Type_368_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_368_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_368_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_368_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_368_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_368_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_368_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_368_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_368_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_368_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_368_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_368_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_368_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_368_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_368_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_368_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_368_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_368_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_368_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_368_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_368_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export interface Type_365 {
    encoded: Bytes
}

export type Type_364 = Type_364_BuyExecution | Type_364_ClaimAsset | Type_364_ClearError | Type_364_ClearOrigin | Type_364_DepositAsset | Type_364_DepositReserveAsset | Type_364_DescendOrigin | Type_364_ExchangeAsset | Type_364_HrmpChannelAccepted | Type_364_HrmpChannelClosing | Type_364_HrmpNewChannelOpenRequest | Type_364_InitiateReserveWithdraw | Type_364_InitiateTeleport | Type_364_QueryHolding | Type_364_QueryResponse | Type_364_ReceiveTeleportedAsset | Type_364_RefundSurplus | Type_364_ReportError | Type_364_ReserveAssetDeposited | Type_364_SetAppendix | Type_364_SetErrorHandler | Type_364_SubscribeVersion | Type_364_Transact | Type_364_TransferAsset | Type_364_TransferReserveAsset | Type_364_Trap | Type_364_UnsubscribeVersion | Type_364_WithdrawAsset
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        AdvisoryCommittee: Type_302,
        Council: Type_303,
        CumulusXcm: Origin,
        PolkadotXcm: Type_306,
        TechnicalCommittee: Type_304,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const Type_361: sts.Type<Type_361> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_364),
        V3: sts.array(() => Type_368),
    }
})
...
export const Type_365: sts.Type<Type_365> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
