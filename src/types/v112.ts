...
export type Call = Call_Assets | Call_Balances | Call_BlockReward | Call_CollatorSelection | Call_Contracts | Call_Council | Call_CumulusXcm | Call_DappsStaking | Call_Democracy | Call_DmpQueue | Call_DynamicEvmBaseFee | Call_EVM | Call_Ethereum | Call_EthereumChecked | Call_Identity | Call_Multisig | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Scheduler | Call_Session | Call_Sudo | Call_System | Call_TechnicalCommittee | Call_Timestamp | Call_Treasury | Call_UnifiedAccounts | Call_Utility | Call_Vesting | Call_XcAssetConfig | Call_XcmpQueue | Call_Xtokens
...
export type Type_315 = Type_315_Response | Type_315_Xcm

export interface Type_315_Response {
    __kind: 'Response'
    value: V3MultiLocation
}

export interface Type_315_Xcm {
    __kind: 'Xcm'
    value: V3MultiLocation
}

export type Type_318 = Type_318_XcmEthereumTx

export interface Type_318_XcmEthereumTx {
    __kind: 'XcmEthereumTx'
    value: AccountId32
}

export type Type_317 = Type_317_EthereumTransaction

export interface Type_317_EthereumTransaction {
...
export type Type_263 = Type_263_V2 | Type_263_V3

export interface Type_263_V2 {
    __kind: 'V2'
    value: Type_266[]
}

export interface Type_263_V3 {
    __kind: 'V3'
    value: Type_270[]
}

export type Type_270 = Type_270_AliasOrigin | Type_270_BurnAsset | Type_270_BuyExecution | Type_270_ClaimAsset | Type_270_ClearError | Type_270_ClearOrigin | Type_270_ClearTopic | Type_270_ClearTransactStatus | Type_270_DepositAsset | Type_270_DepositReserveAsset | Type_270_DescendOrigin | Type_270_ExchangeAsset | Type_270_ExpectAsset | Type_270_ExpectError | Type_270_ExpectOrigin | Type_270_ExpectPallet | Type_270_ExpectTransactStatus | Type_270_ExportMessage | Type_270_HrmpChannelAccepted | Type_270_HrmpChannelClosing | Type_270_HrmpNewChannelOpenRequest | Type_270_InitiateReserveWithdraw | Type_270_InitiateTeleport | Type_270_LockAsset | Type_270_NoteUnlockable | Type_270_QueryPallet | Type_270_QueryResponse | Type_270_ReceiveTeleportedAsset | Type_270_RefundSurplus | Type_270_ReportError | Type_270_ReportHolding | Type_270_ReportTransactStatus | Type_270_RequestUnlock | Type_270_ReserveAssetDeposited | Type_270_SetAppendix | Type_270_SetErrorHandler | Type_270_SetFeesMode | Type_270_SetTopic | Type_270_SubscribeVersion | Type_270_Transact | Type_270_TransferAsset | Type_270_TransferReserveAsset | Type_270_Trap | Type_270_UniversalOrigin | Type_270_UnlockAsset | Type_270_UnpaidExecution | Type_270_UnsubscribeVersion | Type_270_WithdrawAsset

export interface Type_270_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_270_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_270_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_270_ClearError {
    __kind: 'ClearError'
}

export interface Type_270_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_270_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_270_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_270_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}
...
export interface Type_270_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_270_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_270_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_270_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_270_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_270_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_270_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_270_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_270_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_270_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_270_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_270_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_270_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_270_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_270_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_270[]
}

export interface Type_270_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_270[]
}

export interface Type_270_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_270_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_270_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_270_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_270_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_270_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export type Type_266 = Type_266_BuyExecution | Type_266_ClaimAsset | Type_266_ClearError | Type_266_ClearOrigin | Type_266_DepositAsset | Type_266_DepositReserveAsset | Type_266_DescendOrigin | Type_266_ExchangeAsset | Type_266_HrmpChannelAccepted | Type_266_HrmpChannelClosing | Type_266_HrmpNewChannelOpenRequest | Type_266_InitiateReserveWithdraw | Type_266_InitiateTeleport | Type_266_QueryHolding | Type_266_QueryResponse | Type_266_ReceiveTeleportedAsset | Type_266_RefundSurplus | Type_266_ReportError | Type_266_ReserveAssetDeposited | Type_266_SetAppendix | Type_266_SetErrorHandler | Type_266_SubscribeVersion | Type_266_Transact | Type_266_TransferAsset | Type_266_TransferReserveAsset | Type_266_Trap | Type_266_UnsubscribeVersion | Type_266_WithdrawAsset

export interface Type_266_BuyExecution {
    __kind: 'BuyExecution'
    fees: V2MultiAsset
    weightLimit: V2WeightLimit
}

export interface Type_266_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_266_ClearError {
    __kind: 'ClearError'
}

export interface Type_266_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_266_DepositAsset {
    __kind: 'DepositAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    beneficiary: V2MultiLocation
...
export interface Type_266_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V2MultiAssetFilter
    maxAssets: number
    dest: V2MultiLocation
...
export interface Type_266_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}

export interface Type_266_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V2MultiAssetFilter
    receive: V2MultiAsset[]
}
...
export interface Type_266_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V2MultiAssetFilter
    reserve: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_266_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V2MultiAssetFilter
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_266_QueryHolding {
    __kind: 'QueryHolding'
    queryId: bigint
    dest: V2MultiLocation
    assets: V2MultiAssetFilter
...
export interface Type_266_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_266_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_266_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_266[]
}

export interface Type_266_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_266[]
}
...
export interface Type_266_Trap {
    __kind: 'Trap'
    value: bigint
}
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        ...
        CumulusXcm: Type_316,
        Ethereum: Type_317,
        EthereumChecked: Type_318,
        PolkadotXcm: Type_315,
...
export const Type_263: sts.Type<Type_263> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_266),
        V3: sts.array(() => Type_270),
    }
})
...
export const Type_270: sts.Type<Type_270> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_270),
        SetErrorHandler: sts.array(() => Type_270),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_266: sts.Type<Type_266> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_266),
        SetErrorHandler: sts.array(() => Type_266),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
