...
export type Type_229 = Type_229_Architects | Type_229_Fellows | Type_229_Fellowship2Dan | Type_229_Fellowship5Dan | Type_229_Fellowship6Dan | Type_229_Fellowship8Dan | Type_229_Fellowship9Dan | Type_229_Masters | Type_229_Members | Type_229_PromoteTo1Dan | Type_229_PromoteTo2Dan | Type_229_PromoteTo3Dan | Type_229_PromoteTo4Dan | Type_229_PromoteTo5Dan | Type_229_PromoteTo6Dan | Type_229_RetainAt1Dan | Type_229_RetainAt2Dan | Type_229_RetainAt3Dan | Type_229_RetainAt4Dan | Type_229_RetainAt5Dan | Type_229_RetainAt6Dan
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type FellowshipTreasuryCall = FellowshipTreasuryCall_approve_proposal | FellowshipTreasuryCall_check_status | FellowshipTreasuryCall_payout | FellowshipTreasuryCall_propose_spend | FellowshipTreasuryCall_reject_proposal | FellowshipTreasuryCall_remove_approval | FellowshipTreasuryCall_spend | FellowshipTreasuryCall_spend_local | FellowshipTreasuryCall_void_spend

/**
 * See [`Pallet::approve_proposal`].
 */
export interface FellowshipTreasuryCall_approve_proposal {
 ...
 */
export interface FellowshipTreasuryCall_propose_spend {
 ...
 */
export interface FellowshipTreasuryCall_reject_proposal {
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type FellowshipCoreCall = FellowshipCoreCall_approve | FellowshipCoreCall_bump | FellowshipCoreCall_import | FellowshipCoreCall_induct | FellowshipCoreCall_offboard | FellowshipCoreCall_promote | FellowshipCoreCall_set_active | FellowshipCoreCall_set_params | FellowshipCoreCall_submit_evidence
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type AmbassadorTreasuryCall = AmbassadorTreasuryCall_approve_proposal | AmbassadorTreasuryCall_check_status | AmbassadorTreasuryCall_payout | AmbassadorTreasuryCall_propose_spend | AmbassadorTreasuryCall_reject_proposal | AmbassadorTreasuryCall_remove_approval | AmbassadorTreasuryCall_spend | AmbassadorTreasuryCall_spend_local | AmbassadorTreasuryCall_void_spend

/**
 * See [`Pallet::approve_proposal`].
 */
export interface AmbassadorTreasuryCall_approve_proposal {
    __kind: 'approve_proposal'
    proposalId: number
}
 ...
 * See [`Pallet::propose_spend`].
 */
export interface AmbassadorTreasuryCall_propose_spend {
    __kind: 'propose_spend'
    value: bigint
    beneficiary: MultiAddress
}
 ...
 * See [`Pallet::reject_proposal`].
 */
export interface AmbassadorTreasuryCall_reject_proposal {
    __kind: 'reject_proposal'
    proposalId: number
}
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type AmbassadorCoreCall = AmbassadorCoreCall_approve | AmbassadorCoreCall_bump | AmbassadorCoreCall_import | AmbassadorCoreCall_induct | AmbassadorCoreCall_offboard | AmbassadorCoreCall_promote | AmbassadorCoreCall_set_active | AmbassadorCoreCall_set_params | AmbassadorCoreCall_submit_evidence
