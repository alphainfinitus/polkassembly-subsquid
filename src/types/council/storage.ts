...
export const proposalOf =  {
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v136: new StorageType('Council.ProposalOf', 'Optional', [v136.H256], v136.Call) as ProposalOfV136,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v137: new StorageType('Council.ProposalOf', 'Optional', [v137.H256], v137.Call) as ProposalOfV137,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v1300: new StorageType('Council.ProposalOf', 'Optional', [v1300.H256], v1300.Call) as ProposalOfV1300,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1401: new StorageType('Council.ProposalOf', 'Optional', [v1401.H256], v1401.Call) as ProposalOfV1401,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v1500: new StorageType('Council.ProposalOf', 'Optional', [v1500.H256], v1500.Call) as ProposalOfV1500,
}
