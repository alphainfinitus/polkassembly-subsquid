...
export const proposalOf =  {
     ...
     */
    v34: new StorageType('Council.ProposalOf', 'Optional', [v34.H256], v34.Call) as ProposalOfV34,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v36: new StorageType('Council.ProposalOf', 'Optional', [v36.H256], v36.Call) as ProposalOfV36,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v38: new StorageType('Council.ProposalOf', 'Optional', [v38.H256], v38.Call) as ProposalOfV38,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v39: new StorageType('Council.ProposalOf', 'Optional', [v39.H256], v39.Call) as ProposalOfV39,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v40: new StorageType('Council.ProposalOf', 'Optional', [v40.H256], v40.Call) as ProposalOfV40,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v49: new StorageType('Council.ProposalOf', 'Optional', [v49.H256], v49.Call) as ProposalOfV49,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v51: new StorageType('Council.ProposalOf', 'Optional', [v51.H256], v51.Call) as ProposalOfV51,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v56: new StorageType('Council.ProposalOf', 'Optional', [v56.H256], v56.Call) as ProposalOfV56,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
     ...
     *  Actual proposal for a given hash, if it's current.
     */
    v61: new StorageType('Council.ProposalOf', 'Optional', [v61.H256], v61.Call) as ProposalOfV61,
}
...
export const proposalCount =  {
     ...
     *  Proposals so far.
     */
    v34: new StorageType('Council.ProposalCount', 'Default', [], sts.number()) as ProposalCountV34,
}

/**
 *  Proposals so far.
 */
export interface ProposalCountV34  {
    is(block: RuntimeCtx): boolean
...
export const members =  {
     ...
     */
    v34: new StorageType('Council.Members', 'Default', [], sts.array(() => v34.AccountId32)) as MembersV34,
}

/**
 *  The current members of the collective. This is stored sorted (just by value).
 */
export interface MembersV34  {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): v34.AccountId32[]
    get(block: Block): Promise<(v34.AccountId32[] | undefined)>
}
