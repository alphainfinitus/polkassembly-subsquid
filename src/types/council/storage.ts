...
export const proposalOf =  {
     ...
     */
    integriteeParachainV21: new StorageType('Council.ProposalOf', 'Optional', [integriteeParachainV21.H256], integriteeParachainV21.Call) as ProposalOfIntegriteeParachainV21,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    integriteeParachainV22: new StorageType('Council.ProposalOf', 'Optional', [integriteeParachainV22.H256], integriteeParachainV22.Call) as ProposalOfIntegriteeParachainV22,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    integriteeParachainV26: new StorageType('Council.ProposalOf', 'Optional', [integriteeParachainV26.H256], integriteeParachainV26.Call) as ProposalOfIntegriteeParachainV26,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    integriteeParachainV28: new StorageType('Council.ProposalOf', 'Optional', [integriteeParachainV28.H256], integriteeParachainV28.Call) as ProposalOfIntegriteeParachainV28,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    integriteeParachainV29: new StorageType('Council.ProposalOf', 'Optional', [integriteeParachainV29.H256], integriteeParachainV29.Call) as ProposalOfIntegriteeParachainV29,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    integriteeParachainV35: new StorageType('Council.ProposalOf', 'Optional', [integriteeParachainV35.H256], integriteeParachainV35.Call) as ProposalOfIntegriteeParachainV35,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    integriteeParachainV37: new StorageType('Council.ProposalOf', 'Optional', [integriteeParachainV37.H256], integriteeParachainV37.Call) as ProposalOfIntegriteeParachainV37,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    integriteeParachainV41: new StorageType('Council.ProposalOf', 'Optional', [integriteeParachainV41.H256], integriteeParachainV41.Call) as ProposalOfIntegriteeParachainV41,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    integriteeParachainV42: new StorageType('Council.ProposalOf', 'Optional', [integriteeParachainV42.H256], integriteeParachainV42.Call) as ProposalOfIntegriteeParachainV42,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    integriteeParachainV520: new StorageType('Council.ProposalOf', 'Optional', [integriteeParachainV520.H256], integriteeParachainV520.Call) as ProposalOfIntegriteeParachainV520,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    integriteeParachainV540: new StorageType('Council.ProposalOf', 'Optional', [integriteeParachainV540.H256], integriteeParachainV540.Call) as ProposalOfIntegriteeParachainV540,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v551: new StorageType('Council.ProposalOf', 'Optional', [v551.H256], v551.Call) as ProposalOfV551,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v552: new StorageType('Council.ProposalOf', 'Optional', [v552.H256], v552.Call) as ProposalOfV552,
    /**
     *  Actual proposal for a given hash, if it's current.
     */
    v560: new StorageType('Council.ProposalOf', 'Optional', [v560.H256], v560.Call) as ProposalOfV560,
}
...
export const proposalCount =  {
     ...
     *  Proposals so far.
     */
    integriteeParachainV21: new StorageType('Council.ProposalCount', 'Default', [], sts.number()) as ProposalCountIntegriteeParachainV21,
}

/**
 *  Proposals so far.
 */
export interface ProposalCountIntegriteeParachainV21  {
    is(block: RuntimeCtx): boolean
...
export const members =  {
     ...
     */
    integriteeParachainV21: new StorageType('Council.Members', 'Default', [], sts.array(() => integriteeParachainV21.AccountId32)) as MembersIntegriteeParachainV21,
}

/**
 *  The current members of the collective. This is stored sorted (just by value).
 */
export interface MembersIntegriteeParachainV21  {
    is(block: RuntimeCtx): boolean
    getDefault(block: Block): integriteeParachainV21.AccountId32[]
    get(block: Block): Promise<(integriteeParachainV21.AccountId32[] | undefined)>
}
