...
export type Type_319 = Type_319_XcmEthereumTx

export interface Type_319_XcmEthereumTx {
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        ...
        CumulusXcm: Type_317,
        Ethereum: Type_318,
        EthereumChecked: Type_319,
        PolkadotXcm: Type_316,
        TechnicalCommittee: Type_321,
        Void: Void,
        system: RawOrigin,
    }
})
