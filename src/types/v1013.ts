...
export type Call = Call_Balances | Call_CollatorStaking | Call_Council | Call_CumulusXcm | Call_Democracy | Call_Dmarket | Call_Escrow | Call_Marketplace | Call_MessageQueue | Call_Multibatching | Call_Multisig | Call_MythProxy | Call_Nfts | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Preimage | Call_Proxy | Call_Scheduler | Call_Session | Call_Sudo | Call_System | Call_Timestamp | Call_Treasury | Call_Utility | Call_Vesting | Call_XcmpQueue
...
export type Type_360 = Type_360_Relay | Type_360_SiblingParachain

export interface Type_360_Relay {
    __kind: 'Relay'
}

export interface Type_360_SiblingParachain {
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type CollatorStakingCall = CollatorStakingCall_add_invulnerable | CollatorStakingCall_claim_rewards | CollatorStakingCall_leave_intent | CollatorStakingCall_lock | CollatorStakingCall_register_as_candidate | CollatorStakingCall_release | CollatorStakingCall_remove_invulnerable | CollatorStakingCall_set_autocompound_percentage | CollatorStakingCall_set_collator_reward_percentage | CollatorStakingCall_set_desired_candidates | CollatorStakingCall_set_extra_reward | CollatorStakingCall_set_invulnerables | CollatorStakingCall_set_min_candidacy_bond | CollatorStakingCall_set_minimum_stake | CollatorStakingCall_stake | CollatorStakingCall_stop_extra_reward | CollatorStakingCall_top_up_extra_rewards | CollatorStakingCall_unlock | CollatorStakingCall_unstake_all | CollatorStakingCall_unstake_from | CollatorStakingCall_update_candidacy_bond
 ...
 */
export interface CollatorStakingCall_add_invulnerable {
 ...
 */
export interface CollatorStakingCall_claim_rewards {
 ...
 */
export interface CollatorStakingCall_leave_intent {
    __kind: 'leave_intent'
}
 ...
 */
export interface CollatorStakingCall_lock {
    __kind: 'lock'
    amount: bigint
}
 ...
 */
export interface CollatorStakingCall_register_as_candidate {
 ...
 */
export interface CollatorStakingCall_release {
    __kind: 'release'
}
 ...
 * The origin for this call must be the `UpdateOrigin`.
 */
export interface CollatorStakingCall_remove_invulnerable {
 ...
 */
export interface CollatorStakingCall_set_autocompound_percentage {
    __kind: 'set_autocompound_percentage'
    percent: Percent
}
 ...
 * The origin for this call must be the `UpdateOrigin`.
 */
export interface CollatorStakingCall_set_collator_reward_percentage {
    __kind: 'set_collator_reward_percentage'
    percent: Percent
}
 ...
 * The origin for this call must be the `UpdateOrigin`.
 */
export interface CollatorStakingCall_set_desired_candidates {
 ...
 * The origin for this call must be the `UpdateOrigin`.
 */
export interface CollatorStakingCall_set_extra_reward {
    __kind: 'set_extra_reward'
    extraReward: bigint
}
 ...
 * The origin for this call must be the `UpdateOrigin`.
 */
export interface CollatorStakingCall_set_min_candidacy_bond {
    __kind: 'set_min_candidacy_bond'
    bond: bigint
}
 ...
 * The origin for this call must be the `UpdateOrigin`.
 */
export interface CollatorStakingCall_set_minimum_stake {
    __kind: 'set_minimum_stake'
    newMinStake: bigint
}
 ...
 */
export interface CollatorStakingCall_stake {
    __kind: 'stake'
    targets: StakeTarget[]
}
 ...
 * The origin for this call must be the `UpdateOrigin`.
 */
export interface CollatorStakingCall_stop_extra_reward {
    __kind: 'stop_extra_reward'
}
 ...
 * - `Error::<T>::InvalidFundingAmount`: Amount is zero.
 */
export interface CollatorStakingCall_top_up_extra_rewards {
    __kind: 'top_up_extra_rewards'
    amount: bigint
}
 ...
 */
export interface CollatorStakingCall_unlock {
    __kind: 'unlock'
    maybeAmount?: (bigint | undefined)
}
 ...
 */
export interface CollatorStakingCall_unstake_all {
    __kind: 'unstake_all'
}
 ...
 */
export interface CollatorStakingCall_unstake_from {
    __kind: 'unstake_from'
    account: AccountId20
}
 ...
 */
export interface CollatorStakingCall_update_candidacy_bond {
    __kind: 'update_candidacy_bond'
    amount: bigint
}
...
export const CollatorStakingCall: sts.Type<CollatorStakingCall> = sts.closedEnum(() => {
    return  {
        ...
        register_as_candidate: sts.enumStruct({
            bond: sts.bigint(),
        }),
        release: sts.unit(),
        ...
        set_autocompound_percentage: sts.enumStruct({
            percent: Percent,
        }),
        set_collator_reward_percentage: sts.enumStruct({
            percent: Percent,
        }),
        set_desired_candidates: sts.enumStruct({
            max: sts.number(),
        }),
        set_extra_reward: sts.enumStruct({
            extraReward: sts.bigint(),
        }),
        set_invulnerables: sts.enumStruct({
            new: sts.array(() => AccountId20),
        }),
        set_min_candidacy_bond: sts.enumStruct({
            bond: sts.bigint(),
        }),
        set_minimum_stake: sts.enumStruct({
            newMinStake: sts.bigint(),
        }),
        stake: sts.enumStruct({
            targets: sts.array(() => StakeTarget),
        }),
        stop_extra_reward: sts.unit(),
        top_up_extra_rewards: sts.enumStruct({
            amount: sts.bigint(),
        }),
        unlock: sts.enumStruct({
            maybeAmount: sts.option(() => sts.bigint()),
        }),
        unstake_all: sts.unit(),
        unstake_from: sts.enumStruct({
            account: AccountId20,
        }),
        update_candidacy_bond: sts.enumStruct({
            amount: sts.bigint(),
        }),
    }
})

export const StakeTarget: sts.Type<StakeTarget> = sts.struct(() => {
    return  {
        candidate: AccountId20,
        stake: sts.bigint(),
    }
