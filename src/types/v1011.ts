...
export type Type_292 = Type_292_V2 | Type_292_V3 | Type_292_V4

export interface Type_292_V2 {
    __kind: 'V2'
    value: Type_295[]
}

export interface Type_292_V3 {
    __kind: 'V3'
    value: Type_299[]
}

export interface Type_292_V4 {
    __kind: 'V4'
    value: Type_302[]
}
...
export type Type_299 = Type_299_AliasOrigin | Type_299_BurnAsset | Type_299_BuyExecution | Type_299_ClaimAsset | Type_299_ClearError | Type_299_ClearOrigin | Type_299_ClearTopic | Type_299_ClearTransactStatus | Type_299_DepositAsset | Type_299_DepositReserveAsset | Type_299_DescendOrigin | Type_299_ExchangeAsset | Type_299_ExpectAsset | Type_299_ExpectError | Type_299_ExpectOrigin | Type_299_ExpectPallet | Type_299_ExpectTransactStatus | Type_299_ExportMessage | Type_299_HrmpChannelAccepted | Type_299_HrmpChannelClosing | Type_299_HrmpNewChannelOpenRequest | Type_299_InitiateReserveWithdraw | Type_299_InitiateTeleport | Type_299_LockAsset | Type_299_NoteUnlockable | Type_299_QueryPallet | Type_299_QueryResponse | Type_299_ReceiveTeleportedAsset | Type_299_RefundSurplus | Type_299_ReportError | Type_299_ReportHolding | Type_299_ReportTransactStatus | Type_299_RequestUnlock | Type_299_ReserveAssetDeposited | Type_299_SetAppendix | Type_299_SetErrorHandler | Type_299_SetFeesMode | Type_299_SetTopic | Type_299_SubscribeVersion | Type_299_Transact | Type_299_TransferAsset | Type_299_TransferReserveAsset | Type_299_Trap | Type_299_UniversalOrigin | Type_299_UnlockAsset | Type_299_UnpaidExecution | Type_299_UnsubscribeVersion | Type_299_WithdrawAsset

export interface Type_299_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_299_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_299_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_299_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_299_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_299_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_299_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_299_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_299_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_299_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_299_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_299_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_299_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_299_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_299_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_299_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_299_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_299_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_299_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_299_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_299_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export type Type_295 = Type_295_BuyExecution | Type_295_ClaimAsset | Type_295_ClearError | Type_295_ClearOrigin | Type_295_DepositAsset | Type_295_DepositReserveAsset | Type_295_DescendOrigin | Type_295_ExchangeAsset | Type_295_HrmpChannelAccepted | Type_295_HrmpChannelClosing | Type_295_HrmpNewChannelOpenRequest | Type_295_InitiateReserveWithdraw | Type_295_InitiateTeleport | Type_295_QueryHolding | Type_295_QueryResponse | Type_295_ReceiveTeleportedAsset | Type_295_RefundSurplus | Type_295_ReportError | Type_295_ReserveAssetDeposited | Type_295_SetAppendix | Type_295_SetErrorHandler | Type_295_SubscribeVersion | Type_295_Transact | Type_295_TransferAsset | Type_295_TransferReserveAsset | Type_295_Trap | Type_295_UnsubscribeVersion | Type_295_WithdrawAsset
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type MultibatchingCall = MultibatchingCall_batch | MultibatchingCall_batch_v2
 ...
 * 
 */
export interface MultibatchingCall_batch_v2 {
    __kind: 'batch_v2'
    domain: Bytes
    sender: AccountId20
    bias: Bytes
...
export const Type_292: sts.Type<Type_292> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_295),
        V3: sts.array(() => Type_299),
        V4: sts.array(() => Type_302),
    }
})
...
export const Type_295: sts.Type<Type_295> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_295),
        SetErrorHandler: sts.array(() => Type_295),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
