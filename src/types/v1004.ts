...
export type ProxyType = ProxyType_Any | ProxyType_Balances | ProxyType_CancelProxy | ProxyType_NonTransfer
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type MigrationCall = MigrationCall_create_ask | MigrationCall_enable_serial_mint | MigrationCall_force_create | MigrationCall_force_mint | MigrationCall_force_set_migrator | MigrationCall_send_funds_from_pot | MigrationCall_set_collection_metadata | MigrationCall_set_item_owner | MigrationCall_set_next_collection_id | MigrationCall_set_team
 ...
 */
export interface MigrationCall_create_ask {
    __kind: 'create_ask'
    collection: IncrementableU256
    item: bigint
    ask: Ask
 ...
 */
export interface MigrationCall_enable_serial_mint {
    __kind: 'enable_serial_mint'
    collection: IncrementableU256
    dropMaxSupply: boolean
}
 ...
 */
export interface MigrationCall_force_create {
    __kind: 'force_create'
    owner: AccountId20
    config: CollectionConfig
}
 ...
 */
export interface MigrationCall_send_funds_from_pot {
    __kind: 'send_funds_from_pot'
 ...
 */
export interface MigrationCall_set_collection_metadata {
    __kind: 'set_collection_metadata'
    collection: IncrementableU256
    data: BoundedVec
}
 ...
 */
export interface MigrationCall_set_next_collection_id {
    __kind: 'set_next_collection_id'
...
export const MigrationCall: sts.Type<MigrationCall> = sts.closedEnum(() => {
    return  {
        create_ask: sts.enumStruct({
            collection: IncrementableU256,
            item: sts.bigint(),
            ask: Ask,
        }),
        enable_serial_mint: sts.enumStruct({
            collection: IncrementableU256,
            dropMaxSupply: sts.boolean(),
        }),
        force_create: sts.enumStruct({
            owner: AccountId20,
            config: CollectionConfig,
        ...
        send_funds_from_pot: sts.enumStruct({
            recipient: AccountId20,
            amount: sts.bigint(),
        }),
        set_collection_metadata: sts.enumStruct({
        ...
        set_next_collection_id: sts.enumStruct({
            collectionId: IncrementableU256,
        }),
        set_team: sts.enumStruct({
            collection: IncrementableU256,
...
export const Ask: sts.Type<Ask> = sts.struct(() => {
    return  {
        seller: AccountId20,
        price: sts.bigint(),
