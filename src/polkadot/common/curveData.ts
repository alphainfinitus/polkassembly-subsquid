...
import { getStorageData } from '@polkadot/mappings/referendumV2/events/referendaSubmitted';
import { Proposal, CurveData } from '@model/index'
import { getTotalInactiveIssuanceStorageData, getTotalIssuanceStorageData } from '@polkadot/storage/balances';
