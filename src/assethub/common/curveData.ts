...
import { getStorageData } from '@assethub/mappings/referendumV2/events/referendaSubmitted';
import { Proposal, CurveData } from '@model/index'
import { getTotalInactiveIssuanceStorageData, getTotalIssuanceStorageData } from '@assethub/storage/balances';
