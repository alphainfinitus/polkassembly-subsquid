module.exports = class Data1763760252185 {
    name = 'Data1763760252185'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "vote" ("id" character varying NOT NULL, "voter" text, "proposal_id" character varying NOT NULL, "block_number" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "extrinsic_index" text, "decision" character varying(12), "balance" jsonb, "lock_period" integer, "type" character varying(17), CONSTRAINT "PK_2d5932d46afe39c8176f9d4be72" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "status_history" ("id" character varying NOT NULL, "status" character varying(21) NOT NULL, "extrinsic_index" text, "block" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_id" character varying, "preimage_id" character varying, CONSTRAINT "PK_271a5228edb4eeb41bc01d58fac" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "voting_delegation" ("id" character varying NOT NULL, "from" text NOT NULL, "to" text NOT NULL, "balance" numeric, "lock_period" integer NOT NULL, "track" integer, "type" character varying(9) NOT NULL, "extrinsic_index" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "created_at_block" integer NOT NULL, "ended_at" TIMESTAMP WITH TIME ZONE, "ended_at_block" integer, CONSTRAINT "PK_32c0d967d3995c8873ad01220bb" PRIMARY KEY ("id"))`)
