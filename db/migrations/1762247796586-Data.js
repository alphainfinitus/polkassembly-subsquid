module.exports = class Data1762247796586 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "treasury_spend" ("id" character varying NOT NULL, "index" integer NOT NULL, "beneficiary" text, "amount" numeric NOT NULL, "expire_at" integer, "expires_at" TIMESTAMP WITH TIME ZONE, "asset_kind" jsonb, "proposal_id" character varying, "created_at_block" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_at_block" integer, "updated_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_8c06eb3f1cf0be0d565ef90ce69" PRIMARY KEY ("id"))`)
